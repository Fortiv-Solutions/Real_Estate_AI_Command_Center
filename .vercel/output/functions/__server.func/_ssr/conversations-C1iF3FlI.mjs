...
import { A as AppShell, C as Card, P as Pill } from "./AppShell-BaoefHhz.mjs";
import { g as Route$4 } from "./router-DmP4UeSu.mjs";
import { m as ChevronLeft, b as ArrowRight, Y as Sparkles, J as Phone, E as Ellipsis, l as CheckCheck, P as Paperclip, T as Send, Q as RotateCcw, r as CircleQuestionMark, e as Building } from "../_libs/lucide-react.mjs";
...
function ConversationsManager() {
  ...
  const renderPlatformBadge = (channel) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold px-2.5 py-0.5 rounded-full border ${cls}`, children: channel });
  };
  const agentsList = [{
    id: "overview",
    type: "Overview",
...
Fortiv Solutions Team`
  ...
  const renderMenuSelection = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: agentsList.map((agent) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setActiveTab(agent.id), className: "bg-card border shadow-sm rounded-xl p-5 cursor-pointer flex flex-col justify-between group h-48", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold font-mono px-2 py-0.5 rounded-full uppercase border ${agent.id === "overview" ? "bg-slate-100 text-slate-600 border-slate-200" : "bg-ink/5 text-ink border-ink/10"}`, children: agent.type }),
  ...
  const renderOverview = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Conversations Today", value: "84", desc: "Across all channels", color: "text-blue-600" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto space-y-2 pr-1 scrollbar-none", children: liveConversations.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2.5 rounded-xl border border-border bg-background hover:bg-secondary/40 transition-all duration-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground truncate max-w-xs mt-0.5 font-medium", children: [
                  '"',
                  c.msg,
                  '"'
                ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-mono mt-0.5", children: c.mins })
              ] })
            ] })
          ] }, c.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 flex flex-col h-[400px] border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Channel Split" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center items-center h-44 relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col justify-center items-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-semibold", children: "Chats Today" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1.5 border-t border-border pt-3", children: [{
              channel: "WhatsApp Chatbot",
              val: "42%",
              ...
              val: "7%",
              color: "bg-[#29B6F6]"
            }].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs font-medium", children: [
  ...
  const renderWhatsAppAgent = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 md:col-span-4 lg:col-span-3 border border-border p-0 overflow-hidden flex flex-col h-[540px] bg-[#f0f2f5] dark:bg-[#111b21] shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-white dark:bg-[#202c33] border-b border-border flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-emerald-500 text-white px-2 py-0.5 rounded font-bold uppercase", children: "Active" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto divide-y divide-border/20 bg-white", children: Object.keys(whatsappThreads).map((threadKey) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-9 w-9 rounded-full bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 font-bold text-xs flex items-center justify-center shrink-0", children: thread.avatar }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-slate-400 font-mono", children: "online" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-500 truncate mt-0.5 font-medium", children: [
                  '"',
                  thread.lastMsg,
                  '"'
                ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 md:col-span-8 lg:col-span-5 flex flex-col bg-[#efeae2] dark:bg-[#0b141a] border border-border/60 rounded-2xl overflow-hidden h-[540px] shadow-sm relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 bg-emerald-500 text-white flex items-center justify-between shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-white/90 font-medium flex items-center gap-1.5", children: waTyping ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "typing..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: whatsappScrollRef, className: "flex-1 overflow-y-auto p-4 space-y-3 bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] bg-repeat", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#e1f3fb] text-[#54656f] text-xs px-2.5 py-0.5 rounded uppercase tracking-widest font-bold shadow-sm font-display", children: "Autoplay Session (Fortiv AI Assistant)" }) }),
            waMessages.map((m, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isUser ? "justify-end" : "justify-start"} animate-in fade-in duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] rounded-xl px-3 py-1.5 text-xs font-semibold shadow-sm relative ${isUser ? "bg-[#d9fdd3] text-[#111b21] rounded-tr-none" : "bg-white text-[#111b21] rounded-tl-none border border-black/5"}`, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-2 bottom-0.5 flex items-center gap-0.5 text-[10px] text-slate-500 font-mono", children: [
                  m.time,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2.5 bg-[#f0f2f5] dark:bg-[#1f2c34] flex items-center gap-2.5 border-t border-border shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { "aria-label": "Send message", className: "h-9 w-9 bg-emerald-500 rounded-full grid place-items-center text-white hover:bg-emerald-700 transition-colors shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "h-4 w-4 ml-0.5" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-4 flex flex-col justify-between h-[540px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 flex flex-col justify-between flex-1 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-4 text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded border border-emerald-100 w-fit", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest font-display", children: "AI Inbound Qualification" })
            ] }),
            ...
            }].map((field) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs pb-1.5 border-b border-border last:border-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 grid grid-cols-1 md:grid-cols-3 gap-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Conversations Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "42" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Visits Booked MTD" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "14" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Escalation Handoffs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Languages Used" }),
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 font-display", children: "Missed Calls Today" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-emerald-600 font-display", children: "WhatsApp Recovered" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-blue-600 font-display", children: "Recovery Rate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold mt-1 text-blue-600 font-mono", children: recoveryRateStats.recoveryRate })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 font-display", children: "SMS Fallbacks" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-emerald-600 font-display", children: "Overall Recovery" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 overflow-hidden h-[450px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 bg-secondary/30 border-b border-border flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-bold", children: "Telephony webhook status: 🟢 LISTENING" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto flex-1 scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-secondary/20 border-b border-border/80 text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Time" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Caller" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Auto WA Sent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Delay" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "WA Response" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Outcome" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Status" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40", children: missedCallsData.map((call, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedMissedCallIdx(idx), className: `hover:bg-secondary/15 transition-colors cursor-pointer ${isSelected ? "bg-secondary/20 font-semibold border-l-2 border-primary" : ""}`, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 font-bold text-foreground", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-medium font-sans", children: call.name })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${call.status === "Recovered" ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : call.status === "Pending" ? "bg-amber-50 text-amber-600 border border-amber-100" : "bg-red-50 text-red-600 border border-red-100"}`, children: call.status }) })
              ] }, idx);
            }) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 flex flex-col justify-between h-[450px] border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Timeline Tracker" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pl-6 space-y-4 py-2 mt-4 z-10", children: [
              ...
              [{
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-semibold mt-0.5", children: step.desc }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary font-mono mt-0.5", children: step.time })
              ] }, idx))
            ] })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 bg-secondary/30 border-b border-border flex justify-between items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-red-50 text-red-600 border border-red-100 font-bold px-2 py-0.5 rounded-full", children: "Priority Flags: Active" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-secondary/15 border-b border-border/80 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Source" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Call Time" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "WA Sent Time" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "WA Response" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "SMS Sent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "SMS Response" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "CRM Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Priority" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Assigned Agent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Notes" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 font-medium", children: callbackQueueData.map((lead, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-red-50 text-red-600 border border-red-200 px-2 py-0.5 rounded font-black", children: lead.crmStatus }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-red-600 text-white px-1.5 py-0.5 rounded font-black tracking-wider uppercase", children: lead.priority }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 font-bold text-foreground", children: lead.agent }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-2.5 text-muted-foreground text-xs font-medium font-sans", children: [
              '"',
              lead.notes,
              '"'
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-6 flex flex-col bg-[#f5f6fa] border border-border rounded-2xl h-[500px] shadow-sm relative overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border-b border-border px-4 py-2 flex items-center justify-between shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 font-mono", children: "fortivsolutions.in/greenview" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-6 relative flex flex-col justify-end", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[320px] bg-card border border-border shadow-xl rounded-2xl overflow-hidden flex flex-col h-[380px] self-end z-10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: widgetScrollRef, className: "flex-1 overflow-y-auto p-3 space-y-2 bg-[#F8FAFC]", children: [
                widgetMessages.map((m, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${m.from === "user" ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-[85%] rounded-xl px-2.5 py-1.5 text-xs font-semibold ${m.from === "user" ? "bg-primary text-primary-foreground rounded-br-none" : "bg-white text-foreground border border-border rounded-tl-none"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whitespace-pre-line", children: m.text }) }) }, idx)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 border-t border-border/80 flex items-center gap-1.5 bg-white", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { "aria-label": "Widget message input", disabled: true, placeholder: "Type a message...", className: "flex-1 text-xs font-medium h-7 px-2.5 bg-secondary/50 border border-transparent rounded-lg outline-none cursor-not-allowed" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-6 flex flex-col gap-4 h-[500px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden flex-1 flex flex-col border border-border bg-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1 scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-secondary/10 border-b border-border/50 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Visitor Question" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Reference Source" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 font-bold text-xs uppercase tracking-widest font-display", children: "Confidence" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40", children: ragQueryLog.map((r, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15 transition-colors", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 text-slate-500 font-mono text-xs", children: r.src }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden h-[180px] flex flex-col border border-border bg-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1 scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-secondary/10 border-b border-border/50 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 font-bold text-xs uppercase tracking-widest font-display", children: "Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 font-bold text-xs uppercase tracking-widest font-display", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 font-bold text-xs uppercase tracking-widest font-display", children: "Interest" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-1.5 font-bold text-xs uppercase tracking-widest font-display", children: "Status" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40", children: leadCaptureLog.map((l, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/10", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100", children: l.status }) })
              ] }, idx)) })
            ] }) })
          ] })
        ] })
  ...
  const renderTelegramAgent = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-6 flex flex-col bg-[#17212b] border border-border/60 rounded-2xl h-[520px] shadow-sm relative overflow-hidden text-[#f5f6f7]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 bg-[#24303f] flex items-center justify-between shrink-0 border-b border-[#1c2937]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[#708499] font-medium", children: tgTyping ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "bot is typing..." }) : "bot" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: telegramScrollRef, className: "flex-1 overflow-y-auto p-4 space-y-4", children: [
          tgMessages.map((m, idx) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isBot ? "justify-start" : "justify-end"} animate-in fade-in duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] rounded-xl px-3 py-2 text-xs relative ${isBot ? "bg-[#182533] text-[#fff] rounded-tl-none border border-[#203040]" : "bg-[#2b5278] text-[#fff] rounded-tr-none"}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-[10px] text-[#708499] mt-1 font-mono", children: [
                m.time,
                " ",
                isBot ? "" : "✓✓"
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-[#17212b] border-t border-[#1c2937] shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 justify-center mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.comps.cmd, telegramCommands.comps.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all", children: "/comps 2BHK Vesu" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.emi.cmd, telegramCommands.emi.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all", children: "/emi 58L 20" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.pipeline.cmd, telegramCommands.pipeline.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all", children: "/pipeline" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.hot.cmd, telegramCommands.hot.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all", children: "/hot" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.rera.cmd, telegramCommands.rera.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all", children: "/rera Greenview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.inventory.cmd, telegramCommands.inventory.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all", children: "/inventory 2BHK" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => runTelegramCommand(telegramCommands.book.cmd, telegramCommands.book.reply), className: "px-3 py-1 bg-[#24303f] hover:bg-[#2e3e52] text-[#3090cd] text-xs font-bold rounded-full border border-[#1c2937] transition-all font-sans font-bold", children: "/book visit" })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-6 p-0 overflow-hidden h-[520px] flex flex-col border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto flex-1 scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-secondary/15 border-b border-border/80 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Agent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Command Requested" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Query Time" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Outcome Status" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40", children: telegramActivityLog.map((log, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100", children: log.result }) })
          ] }, idx)) })
        ] }) }),
  ...
  const renderVoiceIVR = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 border border-border bg-card p-4 rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Voice Calls Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "24" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "AI Fully Qualified" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "18" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Transferred to Human" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "6" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Avg AI Handle Duration" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden h-[450px] flex flex-col border border-border bg-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto flex-1 scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-secondary/15 border-b border-border/80 text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Time" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Caller" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Language" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Call Duration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "AI Duration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Qualified" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 font-bold text-xs uppercase tracking-widest font-display", children: "Outcome" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40", children: ivrCallsData.map((call, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-slate-600 bg-secondary px-2 py-0.5 rounded border border-border text-xs", children: call.language }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-4 flex flex-col gap-4 h-[450px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 flex-1 flex flex-col justify-between border border-border bg-card overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2.5 border-b border-border pb-2 flex justify-between items-center shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Live Audio Transcript" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedIvrFlow("inbound"), className: `px-2 py-0.5 rounded text-xs font-bold border transition-all ${selectedIvrFlow === "inbound" ? "bg-ink border-ink text-cream" : "bg-card border-border text-muted-foreground"}`, children: "Inbound" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedIvrFlow("after-hours"), className: `px-2 py-0.5 rounded text-xs font-bold border transition-all ${selectedIvrFlow === "after-hours" ? "bg-ink border-ink text-cream" : "bg-card border-border text-muted-foreground"}`, children: "After-Hours" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-2.5 pr-1 p-2 bg-[#f8fafc] border border-border rounded-xl", children: [
                ivrTranscriptMessages.map((m, idx) => {
                  const isAi = m.speaker === "ai";
                  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isAi ? "justify-start" : "justify-end"} animate-in fade-in duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-[85%] rounded-xl px-2.5 py-1.5 text-xs font-semibold leading-relaxed shadow-sm ${isAi ? "bg-slate-100 text-slate-800 border border-border/60 rounded-tl-none" : "bg-primary text-primary-foreground rounded-br-none"}`, children: m.text }) }, idx);
                }),
                ivrPlaying && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-100 border border-border rounded-xl rounded-tl-none px-3 py-1.5 shadow-sm flex gap-1 items-center h-[24px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-slate-400 animate-bounce", style: {
                    animationDelay: "0ms"
                  } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-slate-400 animate-bounce", style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-3 mt-3 flex justify-between items-center shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-emerald-600 font-bold flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }),
                " Qualified"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
                ...
                setIvrIndex(-1);
                setIvrPlaying(true);
              }, className: "h-7 px-3 bg-secondary hover:bg-secondary/70 border border-border rounded-lg text-xs font-bold transition-all flex items-center gap-1 active:scale-95", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "h-3 w-3" }),
                " Replay Call"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-5 h-[180px] flex flex-col justify-between border border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 border-b border-border pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-bold text-foreground", children: "Language Distribution MTD" }) }),
  ...
  const renderEmailResponder = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 border border-border bg-card p-4 rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Inbound Emails Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "34" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "AI Automated Responses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "28" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Mean Delivery Speed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "2m 48s" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "SLA Breaches (Target 3m)" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto divide-y divide-border/60 scrollbar-none", children: emailsData.map((email, idx) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setSelectedEmailIdx(idx), className: `p-3.5 hover:bg-secondary/15 transition-colors cursor-pointer flex items-start justify-between gap-4 ${isSelected ? "bg-secondary/25 border-l-2 border-primary" : ""}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-full bg-secondary border border-border flex items-center justify-center font-bold text-xs text-slate-600 shrink-0", children: email.from[0] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-foreground mt-0.5", children: email.subject }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-1 truncate max-w-sm font-medium", children: [
                    '"',
                    email.original,
                    '"'
                  ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0 flex flex-col items-end gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 font-mono", children: email.received }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 rounded text-xs font-bold bg-[#efe5dd] text-slate-700", children: email.category }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-emerald-600 font-bold font-mono", children: [
                  "✓ ",
                  email.timeTaken
                ] })
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 h-[450px] flex flex-col justify-between border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2 flex justify-between items-center shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Auto-Responder Output" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold text-foreground", children: "AI Draft Response Preview" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100", children: "Approved & Dispatched" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-secondary/30 rounded-xl p-3 border border-border/60 overflow-y-auto font-mono text-xs text-foreground leading-relaxed whitespace-pre-wrap", children: activeEmail?.reply })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 flex flex-col h-[260px] border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Hourly Analytics" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-end gap-5 px-3 pt-6", children: emailHourlyStats.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center gap-2 group h-full justify-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-foreground font-mono opacity-0 group-hover:opacity-100 transition-opacity", children: [
            item.time,
            " (",
            item.count,
            " emails)"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full rounded-t bg-amber-500 transition-all duration-300 opacity-80 group-hover:opacity-100 shadow-sm", style: {
            height: `${item.height}%`
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-muted-foreground font-mono mt-1", children: item.hour })
        ] }, idx)) })
      ] })
    ] });
  };
