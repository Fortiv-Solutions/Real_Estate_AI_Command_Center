...
import { c as Route$8 } from "./router-D7ZC1b3P.mjs";
  ...
  const renderCRMSync = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 p-5 border border-border bg-card mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between border-b border-border/40 pb-3 mb-4 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-bold uppercase tracking-widest text-[#E8A838] flex items-center gap-1.5 font-display", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3.5 w-3.5 animate-pulse text-[#E8A838]" }),
          ...
          duplicates.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-slate-500 font-mono bg-secondary px-2.5 py-1 rounded border border-border/40", children: [
            "Rule triggered: ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-5 p-4 rounded-xl border border-border bg-slate-50 dark:bg-slate-900/10 flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border/40 pb-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10.5px] font-bold text-foreground", children: "Existing CRM Record" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9.5px] bg-[#1A3C5E]/10 text-[#1A3C5E] px-2 py-0.5 rounded font-mono font-bold", children: duplicates[0].cardA.id })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Source" }),
                  renderPlatformBadge(duplicates[0].cardA.source)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Created" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-jb text-[11px] text-slate-600 dark:text-slate-400 font-semibold", children: duplicates[0].cardA.created })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Campaign" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Original Notes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 italic text-[11px] leading-relaxed", children: [
                    '"',
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-5 p-4 rounded-xl border border-border bg-slate-50 dark:bg-slate-900/10 flex flex-col justify-between lg:order-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border/40 pb-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10.5px] font-bold text-foreground", children: "Incoming Sync Record" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9.5px] bg-[#E8A838]/10 text-amber-700 px-2 py-0.5 rounded font-mono font-bold", children: duplicates[0].cardB.id })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Source" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Received" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-jb text-[11px] text-slate-600 dark:text-slate-400 font-semibold", children: duplicates[0].cardB.created })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Campaign" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-slate-400 block font-bold", children: "Incoming Notes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 italic text-[11px] leading-relaxed", children: [
                    '"',
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-2 flex flex-col justify-center gap-1.5 p-3 rounded-xl border border-dashed border-border/60 bg-secondary/5 lg:order-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 text-center mb-1", children: "Conflict Resolver" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-slate-500 text-center leading-relaxed font-semibold", children: "Select values on either card row to resolve conflicting data fields." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [{
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `grid grid-cols-12 gap-3 p-2.5 rounded-xl border transition-all ${isDiff ? "bg-amber-500/5 dark:bg-amber-500/3 border-amber-500/25" : "bg-transparent border-transparent"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 sm:col-span-3 flex flex-col justify-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9.5px] font-bold uppercase tracking-wider text-slate-400 font-display", children: field.label }),
                isDiff && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-extrabold text-[#E8A838] uppercase tracking-widest mt-0.5 animate-pulse", children: "⚠️ Conflict" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => isDiff && setMergedSelections((prev) => ({
                ...prev,
                [field.key]: "cardA"
              })), className: `col-span-12 sm:col-span-4 p-2 rounded-lg border text-xs font-semibold cursor-pointer transition-all flex items-center justify-between ${isSelectedA ? "bg-[#0E86E9]/10 border-[#0E86E9] text-[#0E86E9] shadow-sm" : "bg-background border-border/50 hover:border-slate-400 text-slate-600 dark:text-slate-400"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: valA }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-3.5 w-3.5 rounded-full border flex items-center justify-center shrink-0 ${isSelectedA ? "border-[#0E86E9] bg-[#0E86E9]" : "border-slate-300 bg-transparent"}`, children: isSelectedA && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-2 w-2 text-white stroke-[3px]" }) })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => isDiff && setMergedSelections((prev) => ({
                ...prev,
                [field.key]: "cardB"
              })), className: `col-span-12 sm:col-span-4 p-2 rounded-lg border text-xs font-semibold cursor-pointer transition-all flex items-center justify-between ${isSelectedB ? "bg-[#0E86E9]/10 border-[#0E86E9] text-[#0E86E9] shadow-sm" : isBoth && field.key === "notes" ? "bg-emerald-500/10 border-emerald-500/40 text-emerald-600" : "bg-background border-border/50 hover:border-slate-400 text-slate-600 dark:text-slate-400"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: valB }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-3.5 w-3.5 rounded-full border flex items-center justify-center shrink-0 ${isSelectedB ? "border-[#0E86E9] bg-[#0E86E9]" : isBoth && field.key === "notes" ? "border-emerald-500 bg-emerald-500" : "border-slate-300 bg-transparent"}`, children: (isSelectedB || isBoth) && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-2 w-2 text-white stroke-[3px]" }) })
              ] })
            ] }, field.key);
          }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/15 dark:bg-slate-900/10 border border-border/40 rounded-xl p-4 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400 font-display", children: "Merged Record Preview" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold bg-[#0E86E9]/10 text-[#0E86E9] px-2 py-0.5 rounded font-mono", children: "Ready to commit" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide", children: "Name" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide", children: "Email" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground mt-0.5 block font-mono", children: duplicates[0].cardA.phone })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide", children: "Budget" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide", children: "Locality" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide", children: "Source Channels" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground mt-0.5 block text-[#0E86E9]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs border-t border-border/30 pt-2 text-slate-500 font-medium", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-[9px] block uppercase tracking-wide mb-1 font-bold", children: "Combined Profile Notes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-relaxed text-foreground bg-background p-2.5 rounded-lg border border-border/40 font-semibold italic text-[11px]", children: mergedSelections.notes === "both" ? `${duplicates[0].cardA.notes} 
[Merged from ${duplicates[0].cardB.source}]: ${duplicates[0].cardB.notes}` : mergedSelections.notes === "cardA" ? duplicates[0].cardA.notes : duplicates[0].cardB.notes })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-end gap-3 border-t border-border/40 pt-4", children: [
