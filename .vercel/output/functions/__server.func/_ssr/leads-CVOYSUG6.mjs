...
import { d as Route$7 } from "./router-DmP4UeSu.mjs";
import { a as ArrowLeft, b as ArrowRight, M as MapPin, p as CircleCheck, v as Globe, R as RefreshCw, K as Play, a1 as TriangleAlert, aa as Zap } from "../_libs/lucide-react.mjs";
...
function LeadsManager() {
  ...
  const renderPlatformBadge = (platform) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold px-2.5 py-0.5 rounded-full border ${cls}`, children: platform });
  };
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold text-xs text-foreground flex items-center gap-1.5", children: [
                  lead.name,
                  lead.isNew && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-emerald-600 text-white px-1.5 rounded font-black tracking-wider uppercase animate-pulse", children: "NEW" })
                ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold font-display flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-medium", children: "Score:" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-mono mt-0.5", children: lead.mins })
              ] })
            ] })
          ] }, `${lead.name}-${idx}`)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 flex flex-col h-[400px] border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Source distribution" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center items-center h-44 relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col justify-center items-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-semibold", children: "Leads MTD" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1.5 border-t border-border pt-3", children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs font-medium", children: [
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 p-3 bg-card border border-border/80 rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1", children: "Locality" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1", children: "Property Type" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-8 space-y-3 max-h-[550px] overflow-y-auto pr-1 scrollbar-none", children: filteredFSBO.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center border border-dashed border-border rounded-2xl text-muted-foreground text-xs bg-card", children: "No listings match the selected filters." }) : filteredFSBO.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setSelectedFsboListingId(l.id), className: `p-4 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between ${selectedFsboListingId === l.id ? "bg-secondary/30 border-primary" : "bg-card border-border hover:bg-secondary/15"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                l.isOffMarket && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-red-50 text-red-600 font-bold px-2 py-0.5 rounded-md border border-red-200", children: "Off-Market" })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border mt-4 pt-3 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6 w-6 rounded-full bg-secondary flex items-center justify-center font-bold text-xs text-foreground border border-border", children: l.ownerName[0] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground text-xs", children: l.ownerName }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: l.phone })
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 flex flex-col h-[550px] border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-secondary/30 border border-border rounded-2xl relative overflow-hidden flex items-center justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 inset-x-3 bg-card border border-border p-3 rounded-xl flex flex-col gap-1 shadow-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider font-mono", children: "Discovered Listing Details" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-emerald-600 flex items-center gap-1 font-bold mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }),
                " ",
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 p-3 bg-card border border-border/80 rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1", children: "Segment Type" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 font-bold", children: "Target Market: Surat, Gujarat" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/60", children: filteredBusinesses.map((b) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedBusinessId(b.id), className: `hover:bg-secondary/35 transition-colors cursor-pointer ${isSelected ? "bg-secondary/20 font-semibold border-l-2 border-primary" : ""}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate max-w-xs mt-0.5", children: b.address })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${b.type === "Developer" ? "bg-blue-50 text-blue-600 border border-blue-100" : b.type === "Broker" ? "bg-purple-50 text-purple-600 border border-purple-100" : b.type === "Land Broker" ? "bg-amber-50 text-amber-600 border border-amber-100" : "bg-emerald-50 text-emerald-600 border border-emerald-100"}`, children: b.type }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 font-bold text-amber-500", children: [
                "★ ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground text-xs font-mono", children: b.rating }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                b.enriched.linkedin && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-secondary text-slate-600 border border-border font-bold px-1.5 py-0.5 rounded", children: "LinkedIn" }),
                b.enriched.website && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-secondary text-slate-600 border border-border font-bold px-1.5 py-0.5 rounded", children: "Web" }),
                b.enriched.phone && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-emerald-50 text-emerald-600 font-bold px-1.5 py-0.5 rounded border border-emerald-100", children: "Active" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: b.crmStatus === "Pushed to CRM" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-600 font-bold text-xs flex items-center gap-1", children: "✓ Pushed" }) : b.crmStatus === "Pushing..." ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500 font-bold text-xs flex items-center gap-1 animate-pulse", children: "Pushing..." }) : b.crmStatus === "Not Relevant" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 font-bold text-xs", children: "Skipped" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: (e) => {
                e.stopPropagation();
              ...
              }, className: "h-6 px-2 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-bold transition-all shadow-sm", children: "Push" }) })
            ] }, b.id);
          }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 flex flex-col h-[550px] border border-border bg-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-secondary/30 border border-border rounded-2xl relative overflow-hidden flex items-center justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 inset-x-3 bg-card border border-border p-3 rounded-xl flex flex-col gap-1 shadow-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider font-mono", children: "Google Maps Node" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-xs text-foreground flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedBusiness?.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold px-1.5 py-0.5 rounded bg-secondary text-slate-600 border border-border", children: selectedBusiness?.type })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground flex items-center gap-1 truncate font-medium", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3 text-slate-400" }),
                " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2 pt-2 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-amber-500 font-bold", children: [
                  "★ ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: selectedBusiness?.website, target: "_blank", rel: "noopener noreferrer", className: "text-xs text-primary hover:underline flex items-center gap-0.5 font-bold", children: [
  ...
  const renderAdsSync = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 relative overflow-hidden border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4 border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Real-time Webhook" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative py-4 flex justify-between items-center max-w-4xl mx-auto z-10", children: [
          ...
          [{
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center z-10 relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold mt-2 text-foreground", children: node.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5 font-mono", children: node.text })
            ] }, node.step);
          })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 h-[400px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2 flex justify-between items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Sync Output" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground", children: "Webhook Synced Inbound Feed" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-slate-600 bg-secondary px-2.5 py-0.5 rounded-full border border-border", children: "Avg Capture: 28 seconds" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto space-y-2 scrollbar-none", children: adsLeads.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/15 border border-border/70 rounded-xl hover:bg-secondary/35 transition-all", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-xs text-foreground flex items-center gap-1.5", children: [
                  l.name,
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-slate-400 font-mono", children: [
                    "(",
                    l.syncDurationSec,
                    "s sync duration)"
                  ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3 border-t border-border pt-2 text-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 h-[400px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display font-bold", children: "MTD Analytics" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-3 scrollbar-none text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 font-bold text-xs uppercase tracking-widest text-muted-foreground border-b border-border pb-1", children: [
            ...
            mockCampaigns.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 items-center text-foreground font-medium py-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-5 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold truncate text-xs", children: c.campaign }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-mono", children: c.platform })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-2 text-right font-mono font-bold text-xs", children: c.leads }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 text-right font-mono text-xs", children: [
                "₹",
                c.cpl
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-3 text-right font-mono font-bold text-xs text-primary", children: [
                "₹",
  ...
  const renderPortalAggregator = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-amber-50 border border-amber-200 rounded-2xl flex items-center justify-between gap-3 text-amber-800", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest bg-amber-100 text-amber-700 border border-amber-200 px-2 py-0.5 rounded", children: "3 Merged" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 overflow-hidden h-[500px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/20 border-b border-border flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 font-bold", children: "20 leads in feed" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto divide-y divide-border/60 scrollbar-none", children: portalLeads.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 hover:bg-secondary/15 transition-colors flex items-start justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-7 w-7 rounded-full bg-secondary border border-border flex items-center justify-center font-bold text-xs text-slate-600 shrink-0", children: l.name[0] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-xs text-foreground flex items-center gap-1.5 flex-wrap", children: [
                  l.name,
                  l.isDuplicate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs bg-amber-50 text-amber-700 border border-amber-200 px-1.5 py-0.5 rounded font-bold tracking-wider uppercase flex items-center gap-0.5", children: [
                    "Merged (",
                    l.mergedWith,
                    ")"
                  ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-500 bg-secondary/40 p-2 rounded-lg mt-2 border border-border max-w-md font-medium", children: [
                  '"',
                  l.message,
                  '"'
                ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0 flex flex-col items-end gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 font-mono", children: l.timestamp }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-slate-500 font-mono", children: [
                "Agent: ",
                l.assignedAgent
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 h-[500px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display font-bold", children: "Algorithms Metric" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground", children: "Portal Response Rate Tracker" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "If response rates drop below targets, listings get demoted in search results." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-4 pt-2", children: mockPortalPerformance.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs font-bold px-2 py-0.5 rounded ${p.status === "On Track" ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-red-50 text-red-600 border border-red-100"}`, children: [
                p.rate,
                "%"
              ] })
            ] }),
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto divide-y divide-border/60 scrollbar-none", children: enrichmentLeads.map((l) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setSelectedEnrichmentLeadId(l.id), className: `p-3 transition-colors cursor-pointer flex items-center justify-between gap-3 ${active ? "bg-secondary/25" : "hover:bg-secondary/10"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 font-mono mt-0.5", children: l.phone })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold font-mono text-foreground w-8 text-right", children: [
                  l.completeness,
                  "%"
                ] })
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-4 h-[500px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Expansion View" }),
          ...
          isEnriching ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-[#030712] border border-border rounded-2xl p-6 flex flex-col justify-center items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/15 border border-border/80 p-4 rounded-xl flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-black tracking-widest uppercase text-slate-400 mb-2 font-mono", children: "Raw Lead (Before Enrichment)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Name" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: selectedEnrichmentLead.name })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground font-mono", children: selectedEnrichmentLead.phone })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Source" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: selectedEnrichmentLead.source })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/40 p-2.5 border border-border rounded-lg text-xs text-slate-500 font-bold text-center", children: [
                "Completeness: ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-2 border-ink/20 p-4 rounded-xl flex flex-col justify-between shadow-sm", children: selectedEnrichmentLead.enriched ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-black tracking-widest uppercase text-slate-500 mb-2 font-mono flex items-center justify-between", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-4 gap-y-2.5 text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "WhatsApp status" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Carrier / Operator" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "LinkedIn Profile" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Designation" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: selectedEnrichmentLead.designation })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Company" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: selectedEnrichmentLead.company })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Estimated Income" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground font-mono", children: selectedEnrichmentLead.income })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-semibold", children: "Property Intent" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-emerald-50 text-emerald-700 p-2.5 border border-emerald-100 rounded-lg text-xs font-bold text-center", children: [
                "Total Completeness: ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 mt-1 max-w-[200px] font-semibold", children: "Click the button above to run the AI crawler and enrich fields." })
            ] }) })
          ] })
        ] })
      ] })
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 font-display", children: "Active Leads" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold mt-1 text-foreground font-mono", children: "47" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-red-500 font-display", children: "Hot (75–100)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold mt-1 text-red-500 font-mono", children: "12" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-amber-500 font-display", children: "Warm (40–74)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold mt-1 text-amber-500 font-mono", children: "23" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-primary font-display", children: "Cold (0–39)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold mt-1 text-primary font-mono", children: "12" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-2xl bg-card border border-border text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-indigo-600 font-display", children: "Avg Score" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/60", children: scoringLeads.map((l) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedScoringLeadId(l.id), className: `hover:bg-secondary/15 transition-colors cursor-pointer ${isSelected ? "bg-secondary/20" : ""} ${isUpdated ? upCls + " transition-none" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold font-mono text-xs w-5 text-right text-foreground", children: l.score }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1 bg-secondary rounded-full overflow-hidden border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-full rounded-full transition-all ${l.score >= 75 ? "bg-red-500" : l.score >= 40 ? "bg-amber-500" : "bg-ink"}`, style: {
                  width: `${l.score}%`
                } }) })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider ${l.intent === "hot" ? "bg-red-50 text-red-600 border border-red-100" : l.intent === "warm" ? "bg-amber-50 text-amber-600" : "bg-sky-50 text-sky-600"}`, children: l.intent }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-2.5 font-semibold", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-medium", children: l.budget })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-foreground font-bold", children: l.agent }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-muted-foreground text-xs max-w-[150px] truncate font-medium", children: l.lastActivity })
            ] }, l.id);
          }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 h-[450px] flex flex-col justify-between border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 overflow-y-auto max-h-[280px] scrollbar-none pr-1", children: selectedScoringLead?.reasons.map((r, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start gap-3 text-xs bg-secondary/30 p-2 border border-border rounded-xl", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `font-mono font-bold shrink-0 text-xs ${r.positive ? "text-emerald-600" : "text-red-500"}`, children: [
                r.positive ? "+" : "",
                r.value
              ] })
            ] }, idx)) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 flex flex-col h-[280px] border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Model Calibration" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-end gap-3.5 px-2 pt-4", children: [{
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-foreground font-mono opacity-0 group-hover:opacity-100 transition-opacity", children: item.score }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-muted-foreground truncate w-full text-center tracking-tight mt-1 select-none", children: item.source })
        ] }, idx)) })
      ] })
    ] });
  };
