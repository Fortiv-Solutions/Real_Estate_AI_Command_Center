...
import { A as AppShell, C as Card, P as Pill } from "./AppShell-K5gzIK3d.mjs";
import { g as Route$5 } from "./router-DjkPPp1r.mjs";
import { n as ChevronLeft, b as ArrowRight, Z as Sparkles, N as Phone, E as Ellipsis, m as CheckCheck, P as Paperclip, U as Send, S as RotateCcw, s as CircleQuestionMark, f as Building } from "../_libs/lucide-react.mjs";
...
Fortiv Solutions Team`
  ...
  const renderMenuSelection = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: agentsList.map((agent) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setActiveTab(agent.id), className: "p-5 border border-border/70 hover:border-ink hover:shadow-[0_4px_20px_rgba(11,31,51,0.04)] transition-all duration-300 cursor-pointer flex flex-col justify-between group h-48 bg-card", children: [
