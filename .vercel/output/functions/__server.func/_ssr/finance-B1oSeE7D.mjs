...
import { f as Route$5 } from "./router-DmP4UeSu.mjs";
import { m as ChevronLeft, b as ArrowRight, a0 as TrendingUp, e as Building, o as CircleAlert, a1 as TriangleAlert } from "../_libs/lucide-react.mjs";
...
const statusBadgeStyle = (status) => {
  ...
  if (["Action Required", "Not Initiated", "Not Applied", "Pending Snags", "Blocked", "Payment Pending", "Snag Pending", "At Risk", "Delayed", "Overrun", "Critical Overrun", "Escalated", "Overdue", "Approval pending", "Failed"].some((s) => status.includes(s))) return "bg-red-50 text-red-600 border border-red-100";
...
function FinanceManager() {
  ...
  const renderOverview = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Billed", value: "₹24.6 Cr", desc: "Demand notes raised", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Collected", value: "₹18.2 Cr", desc: "Receipts logged to date", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Collection Rate", value: "74%", desc: "Target threshold: 85%", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Outstanding", value: "₹6.4 Cr", desc: "Receivables balance", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "90+ Day Overdue", value: "₹1.5 Cr", desc: "Escalated collections", color: "text-red-600 animate-pulse" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4 border-b border-border pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-400", children: "Target: ₹3.0 Cr/month" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-44 flex items-end gap-3.5 pt-2", children: monthlyCollectionsTrend.map((t, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-end items-center h-full group relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -top-6 text-xs font-mono font-bold text-foreground opacity-0 group-hover:opacity-100 transition-opacity", children: [
            "₹",
            (t.v / 100).toFixed(2),
            "Cr"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-full rounded-t transition-all duration-300 ${t.status === "Above" ? "bg-emerald-500/80 hover:bg-emerald-500" : "bg-blue-700/80 hover:bg-blue-700"}`, style: {
            height: `${t.v / 400 * 100}%`
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-500 mt-1.5 truncate max-w-full", children: t.m })
        ] }, idx)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1.5 border-b border-border pb-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building, { className: "h-3.5 w-3.5 text-primary" }),
          " Project P&L Summary Snapshot"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3.5 text-xs font-semibold", children: projectPlsData.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `text-xs font-bold ${p.status === "Action Required" ? "text-red-500" : "text-slate-400"}`, children: [
              p.pctMargin,
              "% Margin"
            ] })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3.5 text-xs font-semibold", children: [{
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs font-mono font-bold mt-1.5 pt-1.5 border-t border-current/25", children: [
  ...
  const renderCollections = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Outstanding", value: "₹6.4 Cr", desc: "Billed but unpaid", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Current (Not Yet Due)", value: "₹1.6 Cr", desc: "Due within 30 days", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Overdue (1–60 Days)", value: "₹4.9 Cr", desc: "Active aging tracking", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Critical (90+ Days)", value: "₹1.5 Cr", desc: "23.4% of total outstanding", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-red-50 border border-red-200 rounded-xl text-xs flex items-center gap-3 font-semibold text-red-600 animate-pulse", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card space-y-3.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono bg-red-100 text-red-700 px-2 py-0.5 rounded border border-red-200", children: "Alert Threshold Exceeded" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 text-xs font-semibold", children: [{
          ...
          buyers: "4 buyers",
          pct: 23
        }].map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground", children: row.b }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-normal", children: row.buyers })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 border border-border bg-card overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: filteredOverdues.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `hover:bg-secondary/15 ${b.days >= 90 ? "bg-red-50/10 border-l-2 border-l-red-500" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`Outreach sequence [${b.action}] triggered for ${b.name} via WhatsApp.`), className: `h-6 px-2.5 rounded text-xs font-mono uppercase ${b.days >= 90 ? "bg-red-600 hover:bg-red-700 text-white" : "bg-ink text-cream hover:bg-ink/90"}`, children: b.days >= 90 ? "Legal notice" : "Remind" }) })
          ] }, b.rank)) })
        ] }) })
      ] })
    ] })
  ...
  const renderDemands = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Milestone Trigger Log" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: milestones.map((m, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border/50 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-1.5 py-0.2 rounded font-mono ${statusBadgeStyle(m.status)}`, children: m.status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        m.status.includes("pending") && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => simulateDemandGeneration(m.id, m.milestone), className: "h-7 w-full rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase tracking-wider transition-all", children: "Generate & Send Batch Notes" })
      ] }, m.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Demand Document Preview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert("Downloading PDF template..."), className: "text-xs font-bold text-primary underline font-mono", children: "Download Sample PDF" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-background border border-border/50 rounded-2xl font-mono text-xs leading-relaxed text-slate-600 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center font-bold text-foreground text-xs uppercase border-b border-border pb-2", children: "Fortiv Solutions Pvt Ltd · Demand Letter" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-b border-border py-2 my-2 text-foreground font-semibold", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mt-1 text-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/40 p-2.5 rounded-xl text-[10px] border border-border", children: [
  ...
  const renderCommissions = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total CP Commission (Q1)", value: "₹28.4L", desc: "Cumulative liability", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Commissions Settled", value: "₹19.6L", desc: "Transferred to brokers", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Awaiting Approval", value: "₹6.2L", desc: "Accounts queue pending", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Overdue Settles", value: "₹2.6L", desc: "Auto-reconciles on hold", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Broker Payout Ledgers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: commissions.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: c.status !== "Fully Settled" ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => releaseCommission(c.cp, c.earned), className: "h-6 px-2 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase", children: "Release" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-600 font-bold text-xs", children: "✓ Cleared" }) })
          ] }, c.rank)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Channel Partner Integration Sync" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold text-slate-600 leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border font-mono text-xs space-y-1.5 text-slate-700", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-t border-border pt-1 mt-1 text-foreground font-bold", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadgeStyle(currentPl.status)}`, children: currentPl.status })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Baseline target variances" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold space-y-3", children: [
            ...
            currentPl.status === "Action Required" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-red-200 bg-red-50/20 text-red-700 text-xs animate-pulse", children: [
              "⚠️ ",
  ...
  const renderForecaster = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Opening Balance", value: "₹2.84 Cr", desc: "Remittance accounts", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Projected Inflows (90d)", value: `₹ ${(inflowsProjected / 1e7).toFixed(2)} Cr`, desc: "Milestone billing tranches", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Projected Outflows", value: "₹6.87 Cr", desc: "Subcontractor + procurement", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Funding Gap Alert", value: "₹0.61 Cr", desc: "Required by 1st April 2025", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Scenario Sensitivity Cash modeller" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Projected Outflows Breakdown" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: cashflowOutflows90d.map((o, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-mono font-normal", children: "3-Month Sum" })
          ] })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-red-600 bg-red-50/15 space-y-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-red-600 tracking-wider font-display border-b border-red-200 pb-2", children: "CFO Funding Gap Briefing" }),
  ...
  const renderTallySync = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Sync Success Rate", value: "99.1%", desc: "Last 30 days", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Transactions Pushed", value: "1,842", desc: "Cumulative invoices", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Exceptions in Queue", value: `${syncQueue.length}`, desc: "Awaiting correction", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Last Successful Sync", value: "10 Min ago", desc: "Tally Gateway active", color: "text-blue-700" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Tally Gateway Sync Logs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: tallySyncLogs.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 font-mono truncate max-w-[120px]", children: log.debit }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-mono truncate max-w-[120px]", children: log.credit })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle(log.status)}`, children: log.status }) })
          ] }, log.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Sync Error Reconciliation Panel" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: syncQueue.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center text-slate-400 font-mono", children: "All transactions synced successfully. Error queue empty." }) : syncQueue.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-red-50/10 rounded-xl border border-red-200/50 space-y-2 text-red-600", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-500 font-normal mt-0.5", children: [
              "Error: ",
              e.error
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => clearSyncQueueItem(e.id, e.cp), className: "h-6 w-full rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase tracking-wider", children: [
            "Resolve & Sync Ledger: ",
            e.action
          ] })
        ] }, e.id)) })
  ...
  const renderReports = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "MIS & Compliance Schedules" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: reportSchedules.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border/50 flex justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-bold bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded mr-2", children: r.freq }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.2 rounded font-mono ${statusBadgeStyle(r.status)}`, children: r.status })
        ] })
      ] }, i)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4 flex flex-col justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "One-Click PDF Report Generator" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-normal leading-relaxed", children: "Generates a multi-page styled PDF document pre-populated with live collections ledger values, cash flows projections, and RERA project summaries." })
        ] })
      ] }),
