...
import { h as Route$3 } from "./router-DmP4UeSu.mjs";
...
const statusBadge = (status) => {
  ...
  if (["Action Required", "Not Initiated", "Not Applied", "Pending Snags", "Blocked", "Payment Pending", "Snag Pending", "At Risk", "Delayed", "Overrun", "Critical Overrun", "Escalated", "18 Days Overdue", "34 Days Overdue"].some((s) => status.includes(s))) return "bg-red-50 text-red-600 border border-red-100";
...
function BuyerManager() {
  ...
  const renderOverview = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Buyers", value: "186", desc: "Total registered", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Portal Active (7d)", value: "74", desc: "40% weekly logins", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Payments Overdue", value: "18", desc: "Missed installments", color: "text-red-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Open Snags", value: "9", desc: "Unresolved tickets", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Rolling NPS Score", value: "+62", desc: "Excellent index", color: "text-emerald-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4 border-b border-border pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("payments"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Receipt Manager →" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("nps"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Survey Bot →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs font-semibold", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-normal mt-0.5", children: "74 Promoters (62%) · 29 Passives (24%) · 17 Detractors (14%)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-emerald-600 mt-1", children: "Trend: +54 → +58 → +62 (Improving)" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-3.5 w-3.5 text-blue-700" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 flex items-end gap-1.5 pt-2", children: [41, 38, 52, 47, 61, 58, 74, 69].map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-end items-center h-full group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-blue-700/80 rounded-t hover:bg-blue-700 transition-colors", style: {
              height: `${v}%`
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-slate-400 mt-1", children: [
              "W",
              i + 1
            ] })
          ] }, i)) })
  ...
  const renderSelfService = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-4 items-center justify-between border-b border-border pb-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-bold text-slate-400 bg-secondary px-2.5 py-1 rounded border border-border/60", children: "Aadhaar & WhatsApp OTP Authenticated" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-7 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded border border-emerald-200", children: "RERA Registered" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 text-xs font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 uppercase font-mono", children: "Owner Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground text-sm", children: selectedBuyer.name })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 uppercase font-mono", children: "Total Consideration" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 uppercase font-mono", children: "Registered Area" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 uppercase font-mono", children: "Target RERA Possession" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground", children: "December 2026" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 uppercase font-mono", children: "Relationship Manager" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 uppercase font-mono", children: "Construction Stage" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-slate-400 font-mono", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2 mb-3", children: "Self-Service Document Library" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 text-xs font-semibold", children: [{
            ...
            date: "22/04/2023",
            status: "Available"
          }].map((doc, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-2 rounded-xl bg-background border border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold truncate text-foreground", children: doc.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400 font-mono mt-0.5", children: [
                "Date: ",
                doc.date
              ] })
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-5 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Communication Logs" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold mt-3 text-xs", children: [{
            ...
            time: "25/04/2023"
          }].map((log, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2.5 last:border-0 last:pb-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-sans text-xs leading-relaxed", children: log.msg })
          ] }, idx)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 border-t border-border space-y-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => alert(`Starting simulated WhatsApp chat with ${selectedBuyer.name}...`), className: "w-full h-8 bg-ink hover:bg-ink/90 text-cream rounded-lg text-xs font-bold uppercase tracking-widest transition-all flex items-center justify-center gap-1.5", children: [
  ...
  const renderPayments = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Installments Received", value: "₹16.3Cr", desc: "All-time bookings collections", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Receivables", value: "₹1.61Cr", desc: "18 buyers overdue", color: "text-red-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Next Milestone Demands", value: "₹6.4Cr", desc: "Floor 12 Slab milestone", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Tax Receipts Dispatched", value: "100%", desc: "Auto GST invoices", color: "text-emerald-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Milestone Demand Note Dispatcher" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: demandNotes.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border/50 space-y-2", children: [
          ...
          d.status === "Auto-compile pending" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => compileDemandNotes(d.milestone), className: "w-full h-7 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-bold uppercase tracking-wider transition-all", children: "Compile & Dispatch Demand Notes" })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: ["All", "Overdue", "Current"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPaymentFilter(f), className: `h-6 px-2.5 rounded text-xs font-bold uppercase tracking-wider border transition-all ${paymentFilter === f ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: f }, f)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: filteredPayments.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadge(b.status)}`, children: b.status }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: b.status.includes("Overdue") ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`WhatsApp payment reminder sequence triggered for ${b.name}.`), className: "h-6 px-2 rounded bg-red-600 hover:bg-red-700 text-white text-xs font-mono uppercase shrink-0", children: "Remind" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`Receipt PDF REC/GVH/2025/00${b.id} re-dispatched to email.`), className: "h-6 px-2 rounded border border-border text-xs font-mono hover:bg-secondary", children: "Receipt" }) })
          ] }, b.id)) })
        ] }) })
      ] })
    ] })
  ...
  const renderProgress = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Customized Progress Feed Composer" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border border-dashed border-border rounded-2xl flex flex-col items-center justify-center font-mono text-slate-400 text-xs h-28 relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] bg-slate-100 text-slate-500 px-1.5 rounded mt-1", children: "AI selected from site logs" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border border-dashed border-border rounded-2xl flex flex-col items-center justify-center font-mono text-slate-400 text-xs h-28 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "h-6 w-6 stroke-[1.5] mb-1" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border font-mono text-xs text-slate-600 space-y-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "WhatsApp Message Preview" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-[#ECF3EE] rounded-2xl border border-emerald-100 font-sans text-xs leading-relaxed text-slate-700 font-medium", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-28 bg-emerald-950/10 rounded-xl mb-2 flex items-center justify-center text-slate-400 font-mono text-xs border border-emerald-200", children: "[Embedded Hero Construction Photo]" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/80 border border-slate-200 rounded-xl p-2 mt-2 font-mono text-xs text-slate-600", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-slate-400 font-mono text-xs", children: "Warm regards, Priya Rana (Relationship Manager)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right text-[10px] text-slate-400 mt-1", children: "11:42 AM ✓✓" })
      ] })
    ] })
  ] }) });
  ...
  const renderSnag = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Snags Logged", value: "49", desc: "Post-possession handovers", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Tickets Resolved", value: "40", desc: "81.6% resolution rate", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Open Tickets", value: "9", desc: "Awaiting fix", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Average Resolution", value: "4.2 days", desc: "Turnaround SLA speed", color: "text-blue-700" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Snag Defect Registry" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: snags.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedSnag(s), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedSnag.id === s.id ? "bg-secondary/20 font-bold" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded font-mono font-bold uppercase ${s.severity === "Functional" ? "bg-amber-100 text-amber-700" : s.severity === "Structural" ? "bg-red-100 text-red-700 border border-red-200" : "bg-slate-100 text-slate-500"}`, children: s.severity }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(s.status)}`, children: s.status }) })
          ] }, s.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "AI Triage Case File" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(selectedSnag.status)}`, children: selectedSnag.status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-background border border-border/50 rounded-xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 block mb-1", children: "Issue Description & Note:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-xs leading-relaxed font-sans", children: selectedSnag.note })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-emerald-200 bg-emerald-50/10 text-emerald-700 text-xs font-mono leading-relaxed", children: [
            "⚡ ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: resales.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedListing(r), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedListing.id === r.id ? "bg-secondary/20 font-bold" : ""}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded font-mono font-bold uppercase ${r.type === "Rental" ? "bg-blue-50 text-blue-700" : "bg-purple-50 text-purple-700"}`, children: r.type }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(r.status)}`, children: r.status }) })
        ] }, r.id)) })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Secondary Deal Card" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-display font-bold text-foreground text-sm", children: [
              "Unit ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-purple-200 bg-purple-50/10 text-purple-700 text-xs font-mono leading-relaxed", children: [
            "⭐ ",
  ...
  const renderSociety = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Legal Transfer Steps" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: checklist.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 text-slate-400 font-mono text-xs", children: s.owner }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(s.status)}`, children: s.status }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 text-right", children: s.status !== "Completed" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => markStepComplete(s.id), className: "h-6 px-2 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase", children: "Complete" }) })
        ] }, s.id)) }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Operational Handover Contracts (AMC)" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: [
          amcContracts.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-bold bg-amber-50 text-amber-700 px-1.5 py-0.5 rounded shrink-0", children: a.status })
          ] }, i)),
  ...
  const renderNps = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "NPS Survey responses", value: "68%", desc: "119 of 175 surveyed", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Attributed Bookings", value: "4", desc: "From referrals", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Referral Revenue", value: "₹2.24Cr", desc: "Active pipeline value", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Detractor Cases Pending", value: "3", desc: "Awaiting RM callbacks", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-emerald-600 font-mono", children: "Disbursing ₹10,000 per booking" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: promoters.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`Unique referral tracking link: fortiv.in/loyalty/ref-00${p.id} re-dispatched.`), className: "h-6 px-2 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase", children: "Referral Link" }) })
          ] }, idx)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Detractor Followup Intervention Queue" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs", children: detractors.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-xl border border-red-200 bg-red-50/15 space-y-2 text-red-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Score: ★ ",
              d.nps,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-normal text-slate-500 mt-0.5", children: [
              "Assigned Liaison Manager: ",
              d.rm
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`Urgent RM scheduling task dispatched to ${d.rm} for detractor call.`), className: "w-full h-7 rounded bg-ink text-cream hover:bg-ink/90 text-xs font-bold uppercase tracking-wider font-mono transition-all", children: "Schedule Priority Callback" })
        ] }, i)) })
      ] })
    ] })
  ] });
