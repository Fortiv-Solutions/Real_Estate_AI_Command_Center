...
import { R as Route$c } from "./router-DmP4UeSu.mjs";
...
const statusBadge = (status) => {
  ...
  if (["Mismatch", "Action needed", "Review", "Reject", "Overdue", "Detractor", "Emergency", "Urgent", "Vacating"].some((s) => status.includes(s))) return "bg-red-50 text-red-600 border border-red-100";
...
function TenantPropertyManager() {
  ...
  const renderOverview = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Units Managed", value: "42", desc: "Active properties", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Rent Collected (May)", value: "₹7.8L of ₹9.2L", desc: "84.7% received", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Open Maintenance", value: "8", desc: "Pending resolution", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Leases Expiring (60 Days)", value: "6", desc: "Requiring action", color: "text-red-600 animate-pulse" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Portfolio NPS", value: "74", desc: "Out of 100", color: "text-blue-700" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4 border-b border-border pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("rent"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Ledger Details →" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("maintenance"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Open Queue →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 rounded bg-red-50/50 border border-red-100 text-red-700", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono", children: "Water leakage — GH Flat 8C" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 rounded bg-amber-50/50 border border-amber-100 text-amber-700", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono", children: "AC malfunction · jammed door lock · termites" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 rounded bg-slate-50 border border-slate-200 text-slate-600", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono", children: "Touch-up paint · fan replace · tap drip" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3.5 w-3.5 text-red-600" }),
              " Leases Expiring (60 Days)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("renewal"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Renewal Agent →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 text-xs font-semibold text-slate-600", children: [{
            ...
            days: 48,
            alert: false
          }].map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-1.5 last:border-0 last:pb-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `px-2 py-0.5 rounded text-xs font-mono font-bold shrink-0 ${r.alert ? "bg-red-50 text-red-600 border border-red-100 animate-pulse" : "bg-slate-100 text-slate-500"}`, children: [
              "⏳ ",
              r.days,
              " days"
            ] })
  ...
  const renderScreening = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Applicants", value: "12", desc: "This month", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Awaiting Checks", value: "3", desc: "Verification pending", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Approved / Recommended", value: "7", desc: "Passed identity + credit", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Average CIBIL Score", value: "738", desc: "Salaried applicants", color: "text-blue-700" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: ["All", "Recommended", "Conditional", "Not Recommended"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreeningFilter(f), className: `h-7 px-3 rounded-lg text-xs font-bold uppercase tracking-widest border transition-all ${screeningFilter === f ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: f }, f)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setCompareMode(!compareMode), className: `h-7 px-3 rounded-lg text-xs font-bold uppercase tracking-widest border transition-all ml-auto ${compareMode ? "bg-primary text-white border-primary" : "border-border text-slate-500 hover:bg-secondary"}`, children: compareMode ? "Show Details View" : "Compare Shortlisted Applicants" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `p-0 overflow-hidden border border-border bg-card ${compareMode ? "col-span-12" : "col-span-12 lg:col-span-7"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-400", children: "Target Rent: ₹18,500/month" })
        ] }),
        compareMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-r border-border pr-4 space-y-4 text-slate-500 font-display text-xs uppercase tracking-wider py-2", children: [
          ...
          [initialApplicants[0], initialApplicants[1]].map((app, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-4 rounded-xl border border-border space-y-4 text-slate-700 ${i === 0 ? "bg-emerald-50/10 border-emerald-200" : ""}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-sm text-foreground flex items-center justify-between border-b border-border pb-2", children: [
              app.name,
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(app.recommendation)}`, children: app.recommendation })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: filteredApplicants.map((app) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedApplicant(app), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedApplicant.id === app.id ? "bg-secondary/20 font-bold" : ""}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-mono", children: app.phone })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 text-slate-500 text-xs max-w-[120px] truncate", children: app.employment }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(app.recommendation)}`, children: [
      ...
      !compareMode && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Applicant Score Breakdown" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(selectedApplicant.recommendation)}`, children: selectedApplicant.recommendation })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-semibold", children: selectedApplicant.employment })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 bg-secondary/10 p-2.5 rounded-xl border border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-12 w-12 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute inset-0 flex items-center justify-center text-xs font-extrabold font-mono ${selectedApplicant.score >= 75 ? "text-emerald-600" : selectedApplicant.score >= 50 ? "text-amber-600" : "text-red-600"}`, children: selectedApplicant.score })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/35 rounded-xl p-3 font-mono text-xs leading-relaxed text-slate-600 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-[10px] uppercase tracking-wider text-slate-400 mb-1.5", children: "Score Breakdown:" }),
  ...
  const renderMaintenance = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Tickets Logged", value: "184", desc: "Year to date", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Emergency Tickets", value: "1", desc: "SLA: < 2 hours", color: "text-red-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Urgent Tickets", value: "3", desc: "SLA: Same day", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Avg Resolution Time", value: "3.8 hrs", desc: "Emergency SLA met", color: "text-emerald-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 items-center", children: ["All", "Emergency", "Urgent", "Normal", "In Progress", "Closed"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSeverityFilter(s), className: `h-7 px-3 rounded-lg text-xs font-bold uppercase tracking-widest border transition-all ${severityFilter === s ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: s }, s)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: filteredRequests.map((req) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedRequest(req), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedRequest.id === req.id ? "bg-secondary/20 font-bold" : ""} ${req.severity === "Emergency" && req.status !== "Closed" ? "border-l-2 border-l-red-500 animate-pulse" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(req.severity)}`, children: req.severity }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: req.tenant }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(req.status)}`, children: req.status === "Closed" ? "✅ Resolved" : `🔧 ${req.status}` }) })
          ] }, req.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: [
            "Ticket Details — ",
            selectedRequest.id
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(selectedRequest.severity)}`, children: selectedRequest.severity })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400 font-semibold font-mono", children: [
              "Created: ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl border border-border font-mono text-xs leading-relaxed text-slate-700", children: [
          ...
          selectedRequest.photos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400", children: "Attached Media" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: selectedRequest.photos.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 py-1.5 bg-slate-100 border border-slate-200 rounded-lg font-mono text-xs text-slate-500 flex items-center gap-1 cursor-pointer hover:bg-slate-200", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex gap-2", children: [
            selectedRequest.status === "Pending Dispatch" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 block", children: "Pre-Approved Vendors" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1.5", children: vendorPanel.filter((v) => v.cat === selectedRequest.category).map((v, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => triggerVendorDispatch(selectedRequest.id, v.name), className: "h-8 border border-border bg-background hover:bg-secondary rounded text-xs font-bold text-slate-700 flex flex-col justify-center items-center py-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate max-w-[120px]", children: v.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-normal text-slate-400 font-mono", children: [
                  "★ ",
                  v.rating,
                  " · ",
                  v.resolution
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 block mb-1", children: "WhatsApp Communications" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-emerald-50/50 rounded-xl p-2.5 text-xs leading-relaxed text-slate-600 font-medium border border-emerald-100/50", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2 mb-3", children: "Pre-Approved Vendor Network" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
...
SMS/WhatsApp preview copied to clipboard.`);
  ...
  const renderRent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Monthly Rent Receivable", value: "₹9.24L", desc: "42 units total", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Collected Rent", value: "₹7.82L", desc: "84.7% received", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Outstanding Rent", value: "₹1.41L", desc: "5 units outstanding", color: "text-red-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Late Fees Levied", value: "₹4,230", desc: "2% penalty rule", color: "text-amber-500" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 items-center", children: ["All", "Paid", "Overdue"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setRentFilter(f), className: `h-7 px-3 rounded-lg text-xs font-bold uppercase tracking-widest border transition-all ${rentFilter === f ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: f }, f)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-400", children: "Due Date: 1st of every month" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3.5 py-2.5", children: "Unit" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: filteredLedger.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-mono truncate max-w-[120px]", children: row.project })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(row.status)}`, children: row.status === "Paid" ? "✅ Paid" : `⚠️ Overdue ${row.overdueDays}d` }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: row.status === "Paid" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => alert(`Downloading Digital Receipt RCP-2025-0142 for ${row.tenant}...`), className: "h-6 px-2 rounded border border-border hover:bg-secondary text-xs font-bold text-slate-500 uppercase flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-3 w-3" }),
            " Receipt"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => sendRentReminder(row.tenant), className: "h-6 px-2 rounded bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-700 text-xs font-bold uppercase", children: "Remind" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => generateUpiLink(row.tenant, row.rent), className: "h-6 px-2 rounded border border-border hover:bg-secondary text-xs font-bold text-slate-500 uppercase", children: "UPI Link" })
          ] }) }) })
        ] }, row.id)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2", children: "Automated Reminder Sequence Timeline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-5 gap-3 text-xs font-semibold", children: [{
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold font-mono text-primary uppercase", children: step.day }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: step.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 font-normal leading-relaxed", children: step.desc })
      ] }, i)) })
    ] })
  ] });
  ...
  const renderLoanCopilot = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2", children: "Interactive Eligibility Calculator" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/30 rounded-xl border border-border font-mono text-xs space-y-1 text-slate-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "Loan Sought: ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-7 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2 mb-3", children: "Live Rate Comparisons & EMI Calculations" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium", children: bankRates.map((bank, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2.5 font-bold flex items-center gap-1.5", children: [
                  bank.bank,
                  bank.rate === 8.5 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold bg-emerald-100 text-emerald-700 px-1 py-0.2 rounded border border-emerald-200", children: "Best Rate" }),
                  bank.time.includes("7") && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold bg-blue-100 text-blue-700 px-1 py-0.2 rounded border border-blue-200", children: "Fastest" })
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 text-xs font-semibold", children: [15, 20, 30].map((t) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/15 rounded-xl border border-border/50 text-center space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold font-mono text-primary", children: [
                t,
                " YEARS"
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-semibold text-slate-600 leading-relaxed", children: empType === "Salaried" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground border-b border-border pb-0.5", children: "KYC & Identity:" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground border-b border-border pb-0.5", children: "Income Proofs:" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground border-b border-border pb-0.5", children: "Business KYC:" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground border-b border-border pb-0.5", children: "Financial Documents:" }),
  ...
  const renderNps = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "NPS Snapshot" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-24 w-24 mx-auto", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-wider text-slate-400 font-bold", children: "NPS Score" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold text-slate-500 font-mono", children: [
            "Total Responses: ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-8 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card border-red-200 bg-red-50/10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 font-semibold text-slate-600", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert("Property Manager has initiated contact. Action logged."), className: "h-7 px-3 bg-red-600 hover:bg-red-700 text-white rounded text-xs uppercase font-bold tracking-wider", children: "Log PM Call Outreach" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-white border border-red-100 rounded-xl font-mono text-xs leading-relaxed text-slate-700", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2", children: "Feedback Input Simulator" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: surveys.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(row.classification)}`, children: row.classification }) }),
  ...
  const renderRenewal = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Leases Expiring (Quarter)", value: "14", desc: "Portfolio total", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Renewals Concluded", value: "8", desc: "57% completed", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Negotiations Active", value: "3", desc: "2 in pipeline", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Vacancy Risks", value: "2", desc: "Declined renewal", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: renewals.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedRenewal(row), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedRenewal.id === row.id ? "bg-secondary/20 font-bold" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-slate-400", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `px-1.5 py-0.5 rounded text-xs font-bold ${row.daysAway <= 14 ? "bg-red-50 text-red-600 border border-red-100 animate-pulse" : "bg-slate-100 text-slate-500"}`, children: [
              row.daysAway,
              " days"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-mono", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(row.stage)}`, children: row.stage }) })
          ] }, row.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(selectedRenewal.stage)}`, children: selectedRenewal.stage })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border font-semibold space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-slate-400", children: "Rent Revision Intelligence (Market Comp)" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-slate-500 border-t border-border pt-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 font-mono text-xs text-slate-500 font-semibold border border-border p-2.5 rounded-xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              "Outreach 1 (60d): ",
