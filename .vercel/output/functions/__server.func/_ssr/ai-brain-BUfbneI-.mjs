...
import { j as Route$1 } from "./router-DmP4UeSu.mjs";
...
const statusBadgeStyle = (status) => {
  ...
  if (["Action Required", "Critical", "Withdrawn", "Failed", "alert", "error"].some((s) => s.toLowerCase() === status.toLowerCase())) return "bg-red-50 text-red-600 border border-red-100";
...
function AIBrainModule() {
  ...
  const renderOverview = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Leads Tracked", value: "1,247", desc: "Registered in CRM", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Automations Run Today", value: "8,234", desc: "Cross-module rules", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "WhatsApp Sent", value: "3,812", desc: "Chatbot + RM triggers", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Deals", value: "68", desc: "Pipeline value: ₹42.8Cr", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Data Points Processed", value: "2.4M", desc: "Neural core engine", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-4 border border-border bg-card flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-3 border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-3.5 w-3.5 text-primary" }),
            " Interactive Customer Knowledge Graph"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-400", children: "Click outer nodes to inspect touchpoints" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 flex items-center justify-center relative bg-slate-950/20 rounded-2xl border border-border p-2 min-h-[260px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("lead"), className: `absolute top-[15%] left-[20%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "lead" ? "border-blue-700 scale-110" : "border-border"}`, title: "Lead Source", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-3.5 w-3.5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("agent"), className: `absolute top-[15%] left-[70%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "agent" ? "border-blue-700 scale-110" : "border-border"}`, title: "Agent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-3.5 w-3.5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("property"), className: `absolute top-[43%] left-[10%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "property" ? "border-blue-700 scale-110" : "border-border"}`, title: "Property MATCH", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building, { className: "h-3.5 w-3.5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("whatsapp"), className: `absolute top-[43%] left-[80%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "whatsapp" ? "border-blue-700 scale-110" : "border-border"}`, title: "WhatsApp Feed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-3.5 w-3.5 text-emerald-400" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("payments"), className: `absolute top-[70%] left-[20%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "payments" ? "border-blue-700 scale-110" : "border-border"}`, title: "Payments Ledger", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-3.5 w-3.5 text-amber-500" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("documents"), className: `absolute top-[70%] left-[70%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "documents" ? "border-blue-700 scale-110" : "border-border"}`, title: "Documents AI", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-3.5 w-3.5 text-blue-400" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedGraphNode("nps"), className: `absolute top-[5%] left-[45%] w-9 h-9 rounded-full bg-[#1B263B] border grid place-items-center text-slate-300 z-10 transition-all ${selectedGraphNode === "nps" ? "border-blue-700 scale-110" : "border-border"}`, title: "NPS Survey", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-3.5 w-3.5 text-purple-400" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5 flex flex-col justify-between bg-secondary/20 p-3 rounded-2xl border border-border font-mono text-xs leading-relaxed text-slate-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-slate-100 text-slate-600 px-1.5 py-0.2 rounded font-mono", children: graphNodeDetails.stat })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-sans font-medium text-slate-300 leading-normal", children: graphNodeDetails.text })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("graph"), className: "mt-4 h-7 w-full rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase tracking-wider flex items-center justify-center gap-1", children: [
              "Inspect 360° Profile ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3.5 w-3.5 text-primary animate-pulse" }),
            " Live Neural Core Findings"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-400", children: "Cycles 4 seconds" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-between space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-[10px] font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle("Active")}`, children: [
                activeInsight.type,
                " Insight"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-slate-400 font-bold", children: [
                "Confidence: ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400 font-normal", children: [
              "Route Action: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("health"), className: "text-xs font-bold text-primary underline font-mono", children: "Mission Control" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-xs font-semibold", children: moduleHealthData.map((m, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-1.5 last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            statusDotStyle(m.status),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground text-xs truncate max-w-[200px]", children: m.name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-slate-400 font-bold", children: m.uptime })
        ] }, idx)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3.5 w-3.5 text-red-600" }),
            " High-Risk Active Deals"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("risk"), className: "text-xs font-bold text-primary underline font-mono", children: "Risk Matrix" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: initialRiskDeals.slice(0, 3).map((deal, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center bg-secondary/35 p-2 rounded-xl border border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-foreground text-xs font-bold", children: [
              deal.name,
              " · Unit ",
              deal.unit
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-normal", children: deal.reason })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-red-500 bg-red-50 border border-red-100 px-1.5 py-0.5 rounded text-xs", children: deal.score }) })
        ] }, idx)) })
      ] }) })
    ] })
  ] });
  ...
  const renderGraph = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 border-b border-border pb-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card space-y-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pb-3 border-b border-border", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono text-slate-400 font-bold uppercase tracking-wide", children: [
                "Score: ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border space-y-1.5 font-mono text-xs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Neural Timeline Touchpoints" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-96 overflow-y-auto scrollbar-none space-y-3 pr-1 text-xs", children: customerTimeline.map((evt, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pl-5 border-l border-border/60 pb-3 last:pb-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs text-slate-400 mb-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: evt.time }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-blue-700", children: evt.module })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground font-bold", children: evt.type }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-normal mt-0.5 leading-normal", children: evt.text })
        ] }, idx)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-3 p-4 border border-border bg-card flex flex-col justify-between h-full min-h-[400px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "AI Recommended Action" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-red-50/20 border border-red-200 rounded-xl space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-mono font-bold text-red-600 flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-normal leading-normal mt-1", children: "Unresolved discount objection (₹2L) has stalled the deal. Acknowledging the competitor creates a +18% conversion probability boost." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-secondary/35 rounded-xl border border-border font-mono text-xs text-slate-500 leading-normal", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-7 space-y-3", children: filteredInsights.map((insight) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setExpandedInsight(expandedInsight === insight.id ? null : insight.id), className: `p-4 border transition-all cursor-pointer bg-card ${expandedInsight === insight.id ? "border-primary shadow-sm" : "border-border/60 hover:border-slate-400"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle("Active")}`, children: insight.type }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-slate-400 font-bold", children: [
            "Confidence: ",
            insight.confidence,
            "%"
        ...
        expandedInsight === insight.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-3 border-t border-border text-xs leading-relaxed text-slate-400 space-y-3 font-mono animate-in fade-in duration-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-500 uppercase text-xs tracking-wider block", children: "Recommended Action:" }),
          ...
          }, className: "h-7 w-full rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase tracking-wider mt-1.5", children: "Route Action Playbook" })
        ] })
      ] }, insight.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Historical Recommendation ROI" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3.5 text-xs font-semibold", children: [{
          ...
          verified: true
        }].map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs text-slate-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Actioned: ",
              row.actioned
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-normal leading-normal", children: row.outcome })
        ] }, i)) })
      ] })
    ] })
  ] });
  ...
  const renderRisk = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Active Deals", value: "68", desc: "Pipeline monitor active", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "High-Risk Deals", value: "6", desc: "Requires urgent callback", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Critical Risk Deals", value: "3", desc: "Abandonment imminent", color: "text-red-600 animate-pulse" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Deals Saved This Month", value: "12", desc: "Playbook success rate: 78%", color: "text-emerald-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 border border-border bg-card overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none h-[420px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-xs uppercase tracking-wider font-display sticky top-0 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: initialRiskDeals.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedRiskDeal(b.name), className: `hover:bg-secondary/15 cursor-pointer ${selectedRiskDeal === b.name ? "bg-secondary/20 border-l-2 border-l-primary" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-normal", children: b.project })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle(b.level)}`, children: b.level }) }),
            ...
            }, className: "h-6 px-2 rounded bg-ink text-cream hover:bg-ink/90 text-xs font-mono uppercase", children: "Intervene" }) })
          ] }, i)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card flex flex-col justify-between h-[470px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.2 rounded font-mono ${statusBadgeStyle(riskData.level)}`, children: riskData.level })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-mono text-xs text-slate-600", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border space-y-1.5 text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-t border-border pt-1.5 mt-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-red-50/20 border border-red-200 text-red-600 rounded-xl text-xs leading-normal font-sans", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-mono text-slate-400 bg-secondary/25 p-2 rounded-lg leading-normal", children: [
  ...
  const renderCpPortal = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Broker Deal Submission" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Registered Deals Registry (Admin view)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none h-[340px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: cpDeals.map((deal, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle(deal.status)}`, children: deal.status }) })
          ] }, i)) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Broker network leaderboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: cpLeaderboard.map((cp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-2.5 font-bold", children: [
            cp.name,
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-400 block font-normal font-mono", children: [
              "RERA: ",
              cp.rera
            ] })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "CP Portal Resource Library Kits" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 text-xs font-semibold text-slate-600", children: [{
          ...
          size: "24.5 MB",
          clicks: 98
        }].map((res, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
  ...
  const renderRbac = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: users.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-bold", children: [
              u.name,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 block font-normal font-mono", children: u.email })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-mono", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: u.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-normal", children: u.dept })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs px-1.5 py-0.2 rounded font-mono ${u.mfa ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-700"}`, children: u.mfa ? "Enabled" : "Disabled" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-slate-400 text-xs", children: u.lastLogin }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle(u.status)}`, children: u.status }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => toggleUserStatus(u.id, u.name, u.status), className: `h-6 px-2.5 rounded text-xs font-mono uppercase ${u.status === "Active" ? "bg-red-600 hover:bg-red-700 text-white" : "bg-ink text-cream hover:bg-ink/90"}`, children: u.status === "Active" ? "Suspend" : "Activate" }) })
          ] }, u.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "RBAC Module Permission Matrix" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-mono text-xs text-slate-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-5 text-center font-bold text-foreground border-b border-border pb-1.5", children: [
          ...
          [{
            ...
            e: "All",
            ex: "All"
          }].map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-5 text-center border-b border-border py-2 last:border-0 last:pb-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: consents.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-bold", children: [
              c.name,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-400 block font-normal font-mono", children: c.contact })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-mono", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground truncate max-w-[200px]", children: c.purpose }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 font-normal truncate max-w-[200px]", children: c.text })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-slate-400 text-xs", children: c.source }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-xs", children: c.expiry }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle(c.status)}`, children: c.status }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 text-right", children: c.status === "Active" ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => withdrawConsent(c.id, c.name), className: "h-6 px-2 rounded bg-red-600 hover:bg-red-700 text-white text-xs font-mono uppercase", children: "Withdraw" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500 font-mono text-xs", children: "Withdrawn" }) })
          ] }, c.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Data Subject Requests Queue" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: dsrRequests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-6 text-slate-400", children: "All subject requests resolved successfully." }) : dsrRequests.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border/50 space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs text-slate-400", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-1.5 py-0.2 rounded font-mono ${statusBadgeStyle(r.status)}`, children: r.status })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground text-sm font-bold", children: r.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-400 font-normal mt-0.5", children: [
              r.type,
              " Request: ",
              r.details
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => processDsr(r.id, r.name), className: "h-7 w-full rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase tracking-wider", children: "Approve & Process Request" })
        ] }, r.id)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2 flex justify-between items-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Data Retention Policy Schedule" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-3.5 text-xs font-semibold text-slate-600", children: [{
          ...
          basis: "Income Tax",
          status: "Active"
        }].map((pol, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-foreground", children: pol.type }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-slate-400", children: pol.retention }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-[10px] font-mono mt-2 pt-1 border-t border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Basis: ",
              pol.basis
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-red-600/5 text-red-600 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-red-600/20 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase tracking-wider font-display", children: "Interactive Breach Response Playbook" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-semibold text-xs text-red-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs leading-relaxed font-sans font-medium text-slate-600", children: "In case of a detected security data breach, DPDP 2023 mandates containment actions and DPA notification within 72 hours." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-red-600/10 rounded-xl border border-red-600/20 font-mono text-xs space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
  ...
  const renderHealth = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 border border-border bg-card overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border flex justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-slate-400", children: "Target: 99.5% Uptime" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none max-h-96", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: moduleHealthData.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadgeStyle(m.status)}`, children: m.status }) })
        ] }, i)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Integration API Connector Logs" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-semibold text-xs text-slate-600", children: externalApisHealth.map((api, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground text-xs font-bold", children: api.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400 font-normal", children: [
              "Type: ",
              api.type,
              " · Delay: ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-extrabold px-1.5 py-0.2 rounded font-mono ${statusBadgeStyle(api.status)}`, children: api.status }) })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Live System Workflow Queues" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 font-mono text-xs text-slate-500", children: liveSystemWorkflows.map((flow, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground font-sans font-bold text-xs", children: flow.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400 font-normal mt-0.5", children: [
              "Frequency: ",
              flow.type,
              " · Success: ",
              flow.success
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { title: dynamicTitle, subtitle: headerInfo.subtitle, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "transition-all duration-300", children: [
    activeTab === "menu" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 animate-in fade-in duration-300", children: submodulesList.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setActiveTab(mod.id), className: "bg-card border shadow-sm rounded-xl p-5 cursor-pointer flex flex-col justify-between group h-44", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
