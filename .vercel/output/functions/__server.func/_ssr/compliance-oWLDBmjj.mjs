...
import { h as Route$4 } from "./router-DjkPPp1r.mjs";
import { n as ChevronLeft, b as ArrowRight, h as Calendar, A as Activity, F as FileText, u as Download, U as Send, a3 as Upload, v as Eye, a2 as TriangleAlert, X as ShieldCheck } from "../_libs/lucide-react.mjs";
...
Retained until: 18/01/2032 (7-year law)` }),
  ...
  const renderMenuSelection = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 animate-in fade-in duration-300", children: submodulesList.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setActiveTab(mod.id), className: "p-5 border border-border/70 hover:border-ink hover:shadow-[0_4px_20px_rgba(11,31,51,0.04)] transition-all duration-300 cursor-pointer flex flex-col justify-between group h-48 bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
