...
function CustomTooltip({
  ...
  if (active && payload && payload.length) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass p-3 border border-border/55 rounded-xl text-xs font-semibold shadow-lg text-foreground backdrop-blur-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] uppercase text-slate-400 font-bold mb-1", children: [
        label,
        " Collection"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[#0E86E9]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "Collected:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono-jb text-[#0E86E9] font-bold text-xs", children: [
            "₹",
            payload[0].value,
            " Cr"
          ] })
        ] }),
        payload[0].payload && payload[0].payload.Target !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 border-t border-border/20 pt-1 mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[#D85A30]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "Target:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono-jb text-[#D85A30] font-bold text-xs", children: [
            "₹",
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { title: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif-display font-semibold tracking-tight text-foreground select-none", children: "Real Estate AI Command Center" }) }), subtitle: "Fortiv Solutions · fortivsolutions.in · Executive Build Status Panel", actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setIsAlertsOpen(true), className: "h-9 px-3 rounded-lg border border-border bg-card hover:bg-muted text-[12px] font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1.5 shadow-sm transition-all active:scale-95 cursor-pointer relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-[#D85A30] text-white px-1.5 py-0.5 rounded text-[9px] font-mono font-bold", children: "1 alert" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 font-sans-dm relative z-10 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: consolidatedKPIs.map((kpi, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "submodule-card p-4 rounded-xl flex flex-col justify-between min-h-[108px] transition-all duration-300 relative overflow-hidden", style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 pt-2 border-t border-border/20 text-[9.5px] font-extrabold text-slate-500 flex justify-between items-center font-sans-dm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: kpi.sub }) })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 flex flex-col min-h-[280px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setIsWhatsAppOpen(true), className: "mt-3 w-full h-8 bg-[#25D366] hover:bg-[#20ba56] text-white rounded-lg text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-sm transition-all active:scale-95 cursor-pointer shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-4 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 flex flex-col min-h-[300px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 bg-secondary/10 dark:bg-slate-950/20 border border-border/30 rounded-xl p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1.5 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Today's Pipeline Activity Feed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 max-h-28 overflow-y-auto scrollbar-none pr-1", children: livePipelineLogs.slice(0, 4).map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-slate-500 dark:text-slate-400 font-semibold leading-relaxed flex items-start gap-1 animate-fade-in py-0.5 border-b border-border/5 last:border-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-jb text-[#0E86E9] shrink-0 font-bold", children: log.time }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-3 space-y-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 flex flex-col min-h-[600px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between border-b border-border/40 pb-2 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-border/40 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-jb text-[#1D9E75] font-bold", children: "₹6.4 Cr" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-secondary/40 rounded-full h-1.5 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#1D9E75] h-1.5 rounded-full", style: {
                  width: "71%"
                } }) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-red-500/5 dark:bg-red-950/10 border border-red-500/20 rounded-xl", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9.5px] text-slate-400 mt-1 font-medium", children: "5 buyers unresponsive. Escalate notice workflow." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-amber-500/5 dark:bg-amber-950/10 border border-amber-500/20 rounded-xl", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9.5px] text-slate-400 mt-1 font-medium", children: "18 buyers with pending construction triggers." })
                ] })
              ] })
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-5 flex flex-col justify-between min-h-[270px] relative overflow-hidden bg-card/45 border border-border/60 shadow-lg backdrop-blur-md transition-all duration-300", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-10 -top-10 h-32 w-32 rounded-full bg-primary/10 blur-[30px] pointer-events-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border/20 pb-3 mb-3 relative z-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono font-bold text-muted-foreground", children: [
                insightIndex + 1,
                " / ",
                aiInsights.length
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-center text-left py-2.5 relative z-10 animate-fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-bold px-2.5 py-0.5 rounded-full border tracking-wide uppercase font-mono-jb ${getInsightCategoryStyle(aiInsights[insightIndex].cat)}`, children: aiInsights[insightIndex].cat }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-4 pt-3 border-t border-border/20 relative z-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => alert(`Insight Action triggered: ${aiInsights[insightIndex].cat}`), className: "h-8 px-3.5 rounded-xl bg-primary hover:bg-primary/95 text-primary-foreground text-[10.5px] font-bold uppercase tracking-wider transition-colors flex items-center gap-1.5 shrink-0 shadow-sm shadow-primary/10 cursor-pointer", children: [
    ...
    isWhatsAppOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex justify-end bg-black/40 backdrop-blur-sm animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-96 h-full bg-card border-l border-border shadow-2xl relative animate-in slide-in-from-right duration-300 flex flex-col justify-between overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#075E54] text-white p-4 flex items-center justify-between shadow-md shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-10 w-10 rounded-full bg-emerald-100/20 text-white flex items-center justify-center font-bold text-base relative", children: [
            "💬",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full bg-emerald-400 border border-[#075E54] animate-pulse" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold font-sans", children: "Fortiv AI Agent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-emerald-200/80 font-medium", children: "Online · Live Demo Simulator" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsWhatsAppOpen(false), className: "h-8 w-8 rounded-full hover:bg-[#128C7E] flex items-center justify-center text-white cursor-pointer transition-colors", "aria-label": "Close simulator", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-3 bg-[#E5DDD5] dark:bg-slate-950/40 pattern-grid-lg scrollbar-none hover-scrollbar", children: [
        whatsappMessages.map((msg, i) => {
          if (msg.sender === "system") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center my-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-500/10 dark:bg-slate-800/60 border border-slate-500/20 text-[10px] text-slate-500 dark:text-slate-400 font-bold py-1 px-3 rounded-full text-center max-w-[85%] uppercase tracking-wider font-mono", children: msg.text }) }, i);
          }
          const isUser = msg.sender === "user";
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isUser ? "justify-end" : "justify-start"} animate-fade-in`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[75%] rounded-2xl px-3 py-2 text-xs shadow-sm border ${isUser ? "bg-[#DCF8C6] dark:bg-emerald-950/60 text-slate-800 dark:text-slate-200 border-[#C7EDB1] dark:border-emerald-900/40 rounded-tr-none" : "bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 border-white/20 dark:border-slate-800 rounded-tl-none"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whitespace-pre-wrap", children: msg.text }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-[8px] text-right mt-1 font-semibold ${isUser ? "text-emerald-700/60 dark:text-emerald-400/50" : "text-slate-400/80"}`, children: msg.time })
          ] }) }, i);
        }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-t border-border p-4 shrink-0 space-y-3 shadow-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Simulation Controller" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono bg-secondary px-1.5 py-0.5 rounded text-[8.5px] text-slate-500 font-bold", children: [
            "Step ",
            chatStep,
            "/4"
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          chatStep === 0 && !isAiTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("My budget is ₹40L to ₹60L", 1), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: 'Simulate: "My budget is ₹40L to ₹60L"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-3 w-3 text-[#0E86E9]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("My budget is ₹60L to ₹90L", 1), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
          ...
          chatStep === 1 && !isAiTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("I prefer the Vesu area", 2), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: 'Simulate: "I prefer the Vesu area"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-3 w-3 text-[#0E86E9]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("I prefer Adajan area", 2), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
          ...
          chatStep === 2 && !isAiTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("Looking for Under-construction", 3), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: 'Simulate: "Under-construction preferred"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-3 w-3 text-[#0E86E9]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("Ready possession preferred", 3), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
          ...
          chatStep === 3 && !isAiTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("Yes, please confirm site visit Saturday 11 AM", 4), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: 'Simulate: "Yes, confirm site visit Saturday 11 AM"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-3 w-3 text-[#0E86E9]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleSendMessage("No, let me think about it", 4), className: "w-full text-left p-2.5 rounded-xl border border-[#0E86E9]/20 hover:border-[#0E86E9] hover:bg-[#0E86E9]/5 text-xs text-foreground font-semibold flex items-center justify-between transition-all", children: [
