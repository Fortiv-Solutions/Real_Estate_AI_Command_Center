...
import { c as Route$8 } from "./router-DmP4UeSu.mjs";
import { m as ChevronLeft, b as ArrowRight, G as GitBranch, A as Activity, k as Check, Y as Sparkles, p as CircleCheck, l as CheckCheck, g as Calendar, h as CalendarDays, o as CircleAlert, s as Clock, V as Share2 } from "../_libs/lucide-react.mjs";
...
function SalesPipelineManager() {
  ...
  const [duplicates, setDuplicates] = reactExports.useState([{
    id: "DUP-101",
  ...
  const [mergedSelections, setMergedSelections] = reactExports.useState({
    name: "cardB",
    email: "cardA",
    budget: "cardB",
    locality: "cardB",
  ...
  const [dedupSuccessMsg, setDedupSuccessMsg] = reactExports.useState("");
  const [syncLogs, setSyncLogs] = reactExports.useState(crmSyncLog);
  const [dedupLogs, setDedupLogs] = reactExports.useState(crmDeduplicationLog);
  ...
  const renderPlatformBadge = (source) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold px-2 py-0.5 rounded border font-mono ${cls}`, children: source });
  };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "min-w-[400px] w-full", viewBox: `0 0 ${chartWidth} ${height}`, children: [
      [0, 0.25, 0.5, 0.75, 1].map((r, idx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x, y: chartHeight + paddingTop + 12, textAnchor: "middle", className: "text-[10px] font-mono fill-muted-foreground font-semibold", children: [
            val,
            "d"
          ] })
        ] }, idx);
      ...
      data.map((d, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { className: "group/row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: paddingLeft - 8, y: y + 8, textAnchor: "end", className: "text-[10px] font-bold fill-foreground", children: d.stage }),
  ...
  const renderDashboardOverview = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Deals", value: "23", desc: "Total pipeline", color: "text-slate-800" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "In Negotiation", value: "6", desc: "2 stuck past target", color: "text-amber-500 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Bookings This Month", value: "4", desc: "Closed token amount", color: "text-emerald-600" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Pipeline Value", value: "₹4.2 Cr", desc: "Weighted value ₹1.84Cr", color: "text-blue-700" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-6 p-4 border border-border bg-card flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4 border-b border-border pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("pipeline"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "View Kanban →" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-6 p-4 border border-border bg-card flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3.5 max-h-[300px] overflow-y-auto pr-1 scrollbar-none", children: [{
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-xs leading-relaxed font-semibold border-b border-border pb-2.5 last:border-0 last:pb-0", children: [
  ...
  const handleResolveDuplicate = (action) => {
  ...
  const renderCRMSync = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 border border-border bg-card p-4 rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Synced Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: "118 leads" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Duplicates Merged" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-emerald-600 font-mono mt-1", children: "14 merged" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Sync Health" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Dedup Rate" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden h-[450px] flex flex-col border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 bg-secondary/30 border-b border-border flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded font-mono font-bold", children: "listening..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1 scrollbar-none bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: syncLogs.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${log.status === "Clean" ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-amber-50 text-amber-600 border border-amber-100"}`, children: log.status }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-2.5 font-mono text-xs font-bold text-slate-600", children: log.action }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-2.5 font-mono text-slate-400", children: log.time.split(" ").slice(-1)[0] })
            ] }, log.id)) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-0 overflow-hidden h-[450px] flex flex-col border border-border bg-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex-1 flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: dedupLogs.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-xl border border-border bg-background space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded", children: "Merged" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-medium text-slate-500", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-emerald-600 flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-slate-400 uppercase tracking-widest text-center border-t border-border pt-3", children: "All data transfers compliant with DPDP Act 2023" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 p-5 border border-border bg-card mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between border-b border-border pb-3 mb-4 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-amber-500 flex items-center gap-1.5 font-display", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3.5 w-3.5 animate-pulse text-amber-500" }),
              " Sandbox Conflict Resolver"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold text-sm text-foreground font-display mt-0.5", children: [
              "Visual Deduplication Sandbox (",
              duplicates.length,
              " unresolved)"
            ] })
          ] }),
          duplicates.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-slate-500 font-mono bg-secondary px-2.5 py-1 rounded border border-border", children: [
            "Rule triggered: ",
            duplicates[0].fieldMatch
          ] })
        ] }),
        dedupSuccessMsg && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 p-2.5 text-xs font-semibold text-emerald-700 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200/50 rounded-xl animate-fade-in flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-emerald-600 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: dedupSuccessMsg })
        ] }),
        duplicates.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 animate-in fade-in duration-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-5 p-4 rounded-xl border border-border bg-slate-50 dark:bg-slate-900/10 flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-foreground", children: "Existing CRM Record" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-slate-800/10 text-slate-800 px-2 py-0.5 rounded font-mono font-bold", children: duplicates[0].cardA.id })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Source" }),
                  renderPlatformBadge(duplicates[0].cardA.source)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Created" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-jb text-xs text-slate-600 dark:text-slate-400 font-semibold", children: duplicates[0].cardA.created })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Campaign" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-600 dark:text-slate-400", children: duplicates[0].cardA.campaign })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Original Notes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 italic text-xs leading-relaxed", children: [
                    '"',
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-5 p-4 rounded-xl border border-border bg-slate-50 dark:bg-slate-900/10 flex flex-col justify-between lg:order-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-foreground", children: "Incoming Sync Record" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-amber-500/10 text-amber-700 px-2 py-0.5 rounded font-mono font-bold", children: duplicates[0].cardB.id })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Source" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Received" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-jb text-xs text-slate-600 dark:text-slate-400 font-semibold", children: duplicates[0].cardB.created })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Campaign" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-600 dark:text-slate-400", children: duplicates[0].cardB.campaign })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-slate-400 block font-bold", children: "Incoming Notes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 italic text-xs leading-relaxed", children: [
                    '"',
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-2 flex flex-col justify-center gap-1.5 p-3 rounded-xl border border-dashed border-border/60 bg-secondary/5 lg:order-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 text-center mb-1", children: "Conflict Resolver" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 text-center leading-relaxed font-semibold", children: "Select values on either card row to resolve conflicting data fields." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [{
            ...
            const valA = cardA[field.key];
            const valB = cardB[field.key];
            const isDiff = valA !== valB;
            const isSelectedA = mergedSelections[field.key] === "cardA";
            const isSelectedB = mergedSelections[field.key] === "cardB";
            const isBoth = mergedSelections[field.key] === "both";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `grid grid-cols-12 gap-3 p-2.5 rounded-xl border transition-all ${isDiff ? "bg-amber-500/5 dark:bg-amber-500/3 border-amber-500/25" : "bg-transparent border-transparent"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 sm:col-span-3 flex flex-col justify-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 font-display", children: field.label }),
                isDiff && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-extrabold text-amber-500 uppercase tracking-widest mt-0.5 animate-pulse", children: "⚠️ Conflict" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => isDiff && setMergedSelections((prev) => ({
                ...prev,
                [field.key]: "cardA"
              })), className: `col-span-12 sm:col-span-4 p-2 rounded-lg border text-xs font-semibold cursor-pointer transition-all flex items-center justify-between ${isSelectedA ? "bg-blue-600/10 border-blue-600 text-blue-600 shadow-sm" : "bg-background border-border/50 hover:border-slate-400 text-slate-600 dark:text-slate-400"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: valA }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-3.5 w-3.5 rounded-full border flex items-center justify-center shrink-0 ${isSelectedA ? "border-blue-600 bg-blue-600" : "border-slate-300 bg-transparent"}`, children: isSelectedA && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-2 w-2 text-white stroke-[3px]" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:flex col-span-1 items-center justify-center", children: field.key === "notes" && isDiff ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setMergedSelections((prev) => ({
                ...prev,
                [field.key]: isBoth ? "cardB" : "both"
              })), className: `h-5 px-2 rounded-md font-bold text-[10px] uppercase tracking-wider transition-all border ${isBoth ? "bg-emerald-500/20 border-emerald-500 text-emerald-600" : "bg-background border-border text-slate-400 hover:border-slate-500 hover:text-slate-600"}`, title: "Combine notes from both profiles", children: isBoth ? "Combined" : "Merge" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: `h-3.5 w-3.5 ${isDiff ? "text-amber-500 animate-pulse" : "text-slate-300"}` }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => isDiff && setMergedSelections((prev) => ({
                ...prev,
                [field.key]: "cardB"
              })), className: `col-span-12 sm:col-span-4 p-2 rounded-lg border text-xs font-semibold cursor-pointer transition-all flex items-center justify-between ${isSelectedB ? "bg-blue-600/10 border-blue-600 text-blue-600 shadow-sm" : isBoth && field.key === "notes" ? "bg-emerald-500/10 border-emerald-500/40 text-emerald-600" : "bg-background border-border/50 hover:border-slate-400 text-slate-600 dark:text-slate-400"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: valB }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-3.5 w-3.5 rounded-full border flex items-center justify-center shrink-0 ${isSelectedB ? "border-blue-600 bg-blue-600" : isBoth && field.key === "notes" ? "border-emerald-500 bg-emerald-500" : "border-slate-300 bg-transparent"}`, children: (isSelectedB || isBoth) && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-2 w-2 text-white stroke-[3px]" }) })
              ] })
            ] }, field.key);
          }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/15 dark:bg-slate-900/10 border border-border rounded-xl p-4 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 font-display", children: "Merged Record Preview" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold bg-blue-600/10 text-blue-600 px-2 py-0.5 rounded font-mono", children: "Ready to commit" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide", children: "Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground mt-0.5 block", children: mergedSelections.name === "cardA" ? duplicates[0].cardA.name : duplicates[0].cardB.name })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground mt-0.5 block", children: mergedSelections.email === "cardA" ? duplicates[0].cardA.email : duplicates[0].cardB.email })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground mt-0.5 block font-mono", children: duplicates[0].cardA.phone })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide", children: "Budget" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground mt-0.5 block", children: mergedSelections.budget === "cardA" ? duplicates[0].cardA.budget : duplicates[0].cardB.budget })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide", children: "Locality" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground mt-0.5 block", children: mergedSelections.locality === "cardA" ? duplicates[0].cardA.locality : duplicates[0].cardB.locality })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide", children: "Source Channels" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground mt-0.5 block text-blue-600", children: [
                  duplicates[0].cardA.source,
                  " + ",
                  duplicates[0].cardB.source
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs border-t border-border pt-2 text-slate-500 font-medium", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-xs block uppercase tracking-wide mb-1 font-bold", children: "Combined Profile Notes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-relaxed text-foreground bg-background p-2.5 rounded-lg border border-border font-semibold italic text-xs", children: mergedSelections.notes === "both" ? `${duplicates[0].cardA.notes} 
[Merged from ${duplicates[0].cardB.source}]: ${duplicates[0].cardB.notes}` : mergedSelections.notes === "cardA" ? duplicates[0].cardA.notes : duplicates[0].cardB.notes })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-end gap-3 border-t border-border pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleResolveDuplicate("skip"), className: "h-9 px-4 rounded-xl border border-border bg-card hover:bg-muted text-xs font-bold uppercase tracking-wider text-slate-500 hover:text-foreground transition-all cursor-pointer", children: "Skip Conflict" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleResolveDuplicate("separate"), className: "h-9 px-4 rounded-xl border border-border bg-card hover:bg-muted text-xs font-bold uppercase tracking-wider text-slate-700 hover:text-foreground transition-all cursor-pointer", children: "Keep Separate (2 Leads)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleResolveDuplicate("merge"), className: "h-9 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold uppercase tracking-wider transition-all shadow-sm cursor-pointer flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCheck, { className: "h-4 w-4" }),
              " Confirm & Merge Profiles"
            ] })
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-12 flex flex-col items-center justify-center text-center space-y-3 animate-in fade-in duration-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-full bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 flex items-center justify-center text-emerald-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-6 w-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs text-foreground uppercase tracking-widest font-display", children: "All Conflicts Resolved" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 max-w-[280px]", children: "There are no pending duplicate records in the sync sandbox right now. Nice job!" })
          ] })
        ] })
      ] })
    ] });
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card flex flex-col justify-between min-h-[450px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4 border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold text-xs text-foreground font-display flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-2 text-center text-xs h-[300px]", children: ["Wed 15", "Thu 16", "Fri 17", "Sat 18", "Sun 19", "Mon 20", "Tue 21"].map((day, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl border border-border/60 p-2 flex flex-col justify-between ${isWeekend ? "bg-slate-500/5" : "bg-background"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-muted-foreground block text-xs", children: day }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 py-3 flex flex-col gap-1 justify-center", children: [
                  day.includes("Sat") && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded bg-amber-500/15 border border-amber-500/20 text-[10px] font-bold text-amber-700 truncate", children: "11:00 AM Patel" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded bg-blue-600/15 border border-blue-600/20 text-[10px] font-bold text-primary truncate", children: "03:00 PM Shah" })
                  ] }),
                  day.includes("Sun") && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded bg-emerald-600/15 border border-emerald-600/20 text-[10px] font-bold text-emerald-600 truncate", children: "10:00 AM Deepak" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded bg-slate-100 border border-slate-200 text-[10px] font-bold text-slate-500 truncate", children: "02:00 PM Mehta" })
                  ] }),
                  !day.includes("Sat") && !day.includes("Sun") && idx === 5 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded bg-blue-700/15 border border-blue-700/20 text-[10px] font-bold text-cyan-700 truncate", children: "11:30 AM Joshi" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold text-slate-400 font-mono", children: day.includes("Sat") ? "2 booked" : day.includes("Sun") ? "2 booked" : idx === 5 ? "1 booked" : "0 slots" })
              ] }, idx);
            }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-3 flex justify-between items-center text-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card flex flex-col h-[260px] justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display mb-2.5", children: "Confirmed visit schedule" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-[160px] overflow-y-auto pr-1 scrollbar-none", children: filteredVisits.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-border bg-background flex items-center justify-between text-xs hover:bg-secondary/40 transition-colors", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-foreground flex items-center gap-1.5", children: [
                    v.name,
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono bg-secondary px-1 py-0.5 rounded text-slate-500", children: [
                      "Score: ",
                      v.score
                    ] })
                  ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0 flex flex-col items-end gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs font-semibold text-slate-400", children: [
                    v.time.split(" ")[0],
                    " ",
                    v.time.split(" ")[1]
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-1.5 py-0.5 rounded text-xs font-bold ${v.status === "Rescheduled" ? "bg-amber-50 text-amber-600 border border-amber-100" : "bg-emerald-50 text-emerald-600 border border-emerald-100"}`, children: v.status }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-slate-400 uppercase tracking-widest text-center border-t border-border pt-2.5", children: "Layered reminders sent automatically via WhatsApp (T-24h, Day-of, T-1h)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-5 border border-border bg-card flex flex-col justify-between h-[175px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-red-500 font-display mb-2 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3.5 w-3.5 text-red-500 animate-pulse" }),
              " No-Show registry queue"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: noShowVisits.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs flex items-center justify-between border-b border-border pb-2 last:border-0 last:pb-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert("Reschedule prompt triggered to " + v.name + " WhatsApp."), className: "h-7 px-3 bg-red-50 border border-red-200 hover:bg-red-100 text-red-600 font-bold rounded-lg text-xs transition-colors", children: "Reschedule WhatsApp" })
            ] }, v.id)) })
          ] }) })
        ] })
      ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 font-medium text-foreground bg-background", children: Object.keys(followUpSequences).map((key) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedSequenceKey(key), className: `hover:bg-secondary/15 transition-colors cursor-pointer ${isSelected ? "bg-secondary/25 border-l-2 border-primary font-bold" : ""}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-500 font-medium truncate max-w-xs mt-0.5", children: [
                    '"',
                    seq.lastMsg,
                    '"'
                  ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: seq.objection !== "None" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-2 py-0.5 rounded text-xs font-bold bg-amber-50 text-amber-600 border border-amber-200", children: [
                  "⚠️ ",
                  seq.objection
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 font-mono", children: "—" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${isStuck ? "bg-red-50 text-red-600 border border-red-100" : seq.status === "Slow" ? "bg-amber-50 text-amber-600 border border-amber-100" : "bg-emerald-50 text-emerald-600 border border-emerald-100"}`, children: seq.status }) })
              ] }, key);
            }) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col justify-between h-[480px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2.5 border-b border-border pb-2.5 flex justify-between items-center shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Active Follow-Up Timeline" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs font-bold text-foreground", children: [
                  "Buyer: ",
                  activeSequence.name
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100", children: [
                "Step ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto space-y-3 p-3 bg-secondary/15 rounded-xl border border-border/60 overflow-y-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-slate-400 uppercase tracking-widest text-center mb-1", children: "WhatsApp Conversation Thread" }),
              activeSequence.conversation.map((msg, idx) => {
                const isAi = msg.sender === "ai";
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isAi ? "justify-start" : "justify-end"} animate-in fade-in duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] rounded-xl px-2.5 py-1.5 text-xs leading-relaxed shadow-sm font-semibold ${isAi ? "bg-white text-foreground border border-border rounded-tl-none" : "bg-primary text-primary-foreground rounded-br-none"}`, children: [
                  msg.text,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 font-medium text-foreground bg-background", children: objectionsWebhookRules.map((rule, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-emerald-600 bg-emerald-50 px-2.5 py-0.5 rounded border border-emerald-100 font-extrabold uppercase font-mono", children: "Active Webhook" }) })
          ] }, idx)) })
        ] }) })
      ] })
    ] });
  ...
  const renderDripEngine = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Leads in Drip", value: "142", desc: "Long-term nurture", color: "text-slate-800" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Track B — Warm (60d)", value: "48", desc: "Every 7 days", color: "text-amber-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Track C — Long-Horizon (90d)", value: "70", desc: "Every 14 days", color: "text-blue-700" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden h-[450px] flex flex-col border border-border bg-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 font-medium text-foreground bg-background", children: dripNurtureLeads.map((lead, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `hover:bg-secondary/15 transition-colors ${isReengaged ? "bg-emerald-50/50 font-bold" : ""}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-bold flex items-center gap-1.5", children: [
                  lead.name,
                  isReengaged && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] bg-emerald-500 text-white font-extrabold px-1.5 py-0.5 rounded font-mono uppercase animate-pulse", children: "Re-engaged" })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-mono font-extrabold text-blue-600", children: [
                  lead.clicks,
                  " clicks"
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col justify-between h-[450px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs text-foreground font-display", children: "Drip Content Calendar (14 Days)" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: dripContentCalendar.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-xl border border-border bg-background flex gap-3 hover:bg-secondary/30 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-10 w-10 bg-secondary border border-border rounded-lg shrink-0 flex flex-col justify-center items-center text-center font-bold", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono leading-none text-slate-500 font-extrabold uppercase", children: item.date.split(" ")[1] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-blue-600 uppercase tracking-wider font-mono", children: item.type }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold bg-secondary px-1.5 py-0.5 rounded font-mono", children: item.track })
                ] }),
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-card border border-border rounded-2xl flex justify-between items-center flex-wrap gap-2 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-red-500 font-bold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 animate-pulse text-red-600" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto border border-border bg-card rounded-2xl p-4 min-h-[480px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 min-w-max h-[420px]", children: pipelineStages.map((stg) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onDragOver: handleDragOver, onDrop: () => handleDrop(stg.id), className: "w-[220px] bg-secondary/15 rounded-xl border border-border/80 flex flex-col h-full shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-t-xl border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xs uppercase tracking-wider text-slate-500", children: stg.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold bg-secondary px-1.5 py-0.5 rounded-full", children: stageDeals.length })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-baseline mt-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-slate-400 font-mono", children: [
                "Prob: ",
                stg.probability,
                "%"
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-2.5 space-y-2 scrollbar-none", children: [
            stageDeals.map((deal) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { draggable: true, onDragStart: () => handleDragStart(deal.id), className: "cursor-grab active:cursor-grabbing", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `p-3 border border-border hover:border-slate-300 bg-card transition-all ${isStuck ? "border-red-600 ring-1 ring-[#D85A30]/20 animate-pulse" : isWatch ? "border-amber-400" : ""}`, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 font-semibold leading-relaxed truncate", children: deal.project }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mt-3 pt-2.5 border-t border-border text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-foreground font-mono", children: [
                    "₹",
                    deal.value,
                    "L"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-slate-500 flex items-center gap-0.5", children: [
            ...
            stageDeals.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-slate-400 uppercase tracking-wider font-mono", children: "Drop deal here" }) })
          ] })
        ] }, stg.id);
      }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs text-foreground font-display", children: "Stage Velocity Benchmarks (Fortiv Actual vs Industry average)" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card flex flex-col justify-center min-h-[400px]", children: [
          ...
          writerStatus === "generated" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in slide-in-from-bottom duration-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 border-b border-border pb-2", children: [{
              ...
              id: "gujarati",
              label: "Gujarati Copy"
            }].map((tab2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveOutputTab(tab2.id), className: `h-7 px-2.5 rounded-lg text-xs font-bold border transition-all ${activeOutputTab === tab2.id ? "bg-ink border-ink text-cream" : "bg-background border-border text-slate-500 hover:bg-muted"}`, children: tab2.label }, tab2.id)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border/60 font-mono text-xs text-foreground leading-relaxed whitespace-pre-wrap max-h-[220px] overflow-y-auto scrollbar-none", children: [
...
સંપર્ક: +91 XXXXX XXXXX`
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 font-medium text-foreground bg-background", children: publishedListingsLog.map((list, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${list.status === "Fresh" ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-amber-50 text-amber-600 border border-amber-100 animate-pulse"}`, children: list.status }) })
          ] }, idx)) })
        ] }) })
      ] })
    ] });
  ...
  const renderMenuSelection = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: submodulesList.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setActiveTab(mod.id), className: "bg-card border shadow-sm rounded-xl p-5 cursor-pointer flex flex-col justify-between group h-48", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }),
          " ",
          mod.status
        ] }) }),
