...
import { b as Route$9 } from "./router-DmP4UeSu.mjs";
import { m as ChevronLeft, b as ArrowRight, L as Layers, o as CircleAlert, D as DollarSign, W as ShieldCheck, s as Clock, a1 as TriangleAlert, Y as Sparkles, a2 as Upload, i as Camera } from "../_libs/lucide-react.mjs";
...
const statusBadge = (status) => {
  ...
  if (["Action Required", "Not Initiated", "Not Applied", "Pending Snags", "Blocked", "Payment Pending", "Snag Pending", "At Risk", "Delayed", "Overrun", "Critical Overrun"].some((s) => status.includes(s))) return "bg-red-50 text-red-600 border border-red-100";
...
function ProjectManager() {
  ...
  const renderOverview = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Overall Progress", value: "67%", desc: "All phases complete", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Budget Utilised", value: "₹16.2Cr / ₹28.4Cr", desc: "57% budget spent", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Contractors", value: "14", desc: "Trades with active WOs", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Approvals Pending", value: "3", desc: "Statutory NOCs / Files", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Days to Possession", value: "571", desc: "Dec 2026 RERA date", color: "text-red-600" })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-7 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("timeline"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Milestone Tracker →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [{
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0 min-w-[100px]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-xs font-semibold mt-0.5 ${m.status === "At Risk" ? "text-red-500" : "text-slate-400"}`, children: m.days })
            ] })
          ] }, i)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3.5 w-3.5 text-red-600" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-xs font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2.5 rounded-xl border border-red-200 bg-red-50/20 text-red-600", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🔴 Fire NOC — Application not submitted. Possession blocker." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("approvals"), className: "text-xs font-bold underline font-mono shrink-0 ml-2", children: "Resolve →" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2.5 rounded-xl border border-amber-200 bg-amber-50/20 text-amber-700", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("approvals"), className: "text-xs font-bold underline font-mono shrink-0 ml-2", children: "Review →" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2.5 rounded-xl border border-amber-200 bg-amber-50/20 text-amber-700", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🟡 Floors 9–14 Structure — 3 days behind schedule. Cascade: +12 days on MEP." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("timeline"), className: "text-xs font-bold underline font-mono shrink-0 ml-2", children: "Impact Chart →" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("cost"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Cost Forecaster →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 text-xs font-semibold", children: [{
            ...
            pct: 142,
            status: "Overrun"
          }].map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `px-2 py-0.5 rounded text-xs font-mono font-bold shrink-0 ${c.status === "Overrun" ? "bg-red-50 text-red-600 border border-red-100 animate-pulse" : "bg-slate-100 text-slate-500"}`, children: [
              c.pct,
              "% Used"
            ] })
          ] }, i)) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab("approvals"), className: "text-xs font-bold text-primary hover:underline font-mono", children: "Approvals Board →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-14 w-14 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 flex items-center justify-center font-mono font-extrabold text-xs text-emerald-600", children: "43%" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground", children: "OC Readiness Score" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 font-normal mt-0.5", children: "38 of 240 units snagged · Water connections connecting · Substation pending NOC" })
            ] })
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-red-200 bg-red-50/10 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-3 text-xs font-semibold", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-6 w-6 text-red-600 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-lg font-extrabold text-red-600 px-4 py-1.5 rounded-xl bg-red-50 border border-red-200", children: "571 DAYS REMAINING" })
    ] })
  ] });
  ...
  const renderTimeline = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Construction Phases", value: "15", desc: "Land to Handover", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Phases Completed", value: "7", desc: "Foundation + Structural 1-8", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "At Risk / Delayed", value: "1", desc: "Structural Floors 9-14", color: "text-red-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Delay Downstream Cascade", value: "+12 Days", desc: "MEP start impact", color: "text-amber-500" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-slate-400 flex items-center gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 max-h-[460px] overflow-y-auto pr-1 scrollbar-none", children: initialPhases.map((phase) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setSelectedPhase(phase), className: `p-3 rounded-xl border cursor-pointer hover:bg-secondary/15 transition-all ${selectedPhase.id === phase.id ? "bg-secondary/20 border-primary" : "border-border bg-background"} ${phase.critical ? "border-l-4 border-l-amber-500" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs font-semibold mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-slate-400 text-xs", children: phase.id }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: phase.name }),
              phase.critical && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold bg-amber-100 text-amber-700 px-1 rounded font-mono", children: "Critical" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-bold text-foreground", children: [
              phase.pct,
              "%"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.5 rounded font-mono ${statusBadge(phase.status)}`, children: phase.status })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs font-mono text-slate-400 mt-1 font-semibold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card space-y-4 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border pb-2 flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(selectedPhase.status)}`, children: selectedPhase.status })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border font-mono text-xs space-y-1 text-slate-600", children: [
              ...
              selectedPhase.cascade > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-red-500 font-bold border-t border-border pt-1 mt-1", children: [
                "⚠️ Cascade impact: +",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 pt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400", children: "Sub-Phases / Floor Breakdown" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: selectedPhase.subPhases.map((sb, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 rounded bg-background border border-border/50 font-mono text-xs flex justify-between", children: [
  ...
  const renderSubcontractor = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Empaneled Subcontractors", value: "24", desc: "Across 8 trades", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Work Orders", value: "14", desc: "Live on site", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Milestone Payments Certified", value: "₹44.1L", desc: "This month", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Subcontractor Expiry Alerts", value: "1", desc: "Patel Plumbing Co.", color: "text-amber-500" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-secondary/35 border-b border-border text-xs font-bold uppercase text-slate-500 font-display", children: "Contractor Registry" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: contractors.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedContractor(c), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedContractor.id === c.id ? "bg-secondary/20 font-bold" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(c.status)}`, children: c.status }) })
          ] }, c.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Contractor Profile" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${selectedContractor.performance >= 80 ? "bg-emerald-50 text-emerald-700" : "bg-amber-50 text-amber-700"}`, children: [
            "★ ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-400 font-normal", children: [
              "Trade Scope: ",
          ...
          selectedContractor.name === "Patel Plumbing Co." && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-amber-200 bg-amber-50/20 text-amber-700 text-xs", children: [
            "⚠️ ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 block border-b border-border pb-1", children: "Work Orders & Payments" }),
            activeWos.map((wo, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded bg-background border border-border/50 space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.2 rounded ${statusBadge(wo.status)}`, children: wo.status })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: wo.scope }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs text-slate-400 font-semibold border-t border-border pt-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "Val: ₹",
              ...
              wo.status !== "Completed" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => certifyMilestonePayment(wo.id, wo.value), className: "w-full h-6 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase tracking-wider mt-1", children: "Certify & Release Milestone Payment" })
            ] }, i))
          ] })
        ] })
      ] })
  ...
  const renderProcurement = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Indents Raised (Month)", value: "42", desc: "Slabs + blockwork indents", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "POs Dispatched", value: "38", desc: "₹48.2L procurement value", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Deliveries In Transit", value: "1", desc: "Plumbing CPVC pipes", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Stock Shortage Alert", value: "OPC 53", desc: "Cement running low (~2.3d)", color: "text-red-600" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 items-center", children: ["All", "PO Sent", "In Transit", "Delivered"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setProcFilter(f), className: `h-7 px-3 rounded-lg text-xs font-bold uppercase tracking-widest border transition-all ${procFilter === f ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: f }, f)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: filteredProc.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(row.status)}`, children: row.status }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: row.status === "PO Sent" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => dispatchMaterialPO(row.id), className: "h-6 px-2 rounded bg-ink hover:bg-ink/90 text-cream text-xs font-mono uppercase", children: "Dispatch" }) })
          ] }, row.id)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "L1 Vendor Comparison — Concrete" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold text-slate-600", children: [
          [{
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-[10px] font-bold uppercase tracking-wider ${i === 0 ? "text-emerald-600" : "text-slate-400"}`, children: v.status })
            ] })
          ] }, i)),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-slate-400", children: "Comparing quotes automatically matches and highlights L1 according to Fortiv Solutions procurement policies." })
        ] })
      ] })
    ] })
  ] });
  ...
  const renderApprovals = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Required Approvals", value: "14", desc: "RERA to Occupancy", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Approvals Complete", value: "9", desc: "NOCs / Permits complete", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Liaison Reviews Pending", value: "2", desc: "Action needed", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "OC Readiness Score", value: "43%", desc: "Aggregated pre-conditions", color: "text-blue-700" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: approvals.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-semibold text-slate-500", children: row.blocksPossession ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-600", children: "Critical block" }) : "No" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(row.status)}`, children: row.status }) })
          ] }, i)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-3.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border pb-2", children: "OC Pre-Condition Checklists (43%)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 text-xs font-semibold", children: ocReadinessList.map((oc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border pb-2 last:border-0 last:pb-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-blue-700", children: oc.status })
          ] }, i)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-amber-500 bg-amber-50/10 space-y-3", children: [
  ...
  const renderSitePhotos = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: sitePhotos.map((photo) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setSelectedPhoto(photo), className: `p-3 rounded-2xl border cursor-pointer transition-all space-y-2 hover:shadow-md ${selectedPhoto.id === photo.id ? "border-primary bg-secondary/15" : "border-border bg-background"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-28 bg-secondary/40 rounded-xl flex items-center justify-center font-mono text-xs text-slate-400 border border-border relative overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "h-6 w-6 stroke-[1.5]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-2 left-2 bg-black/60 text-white px-2 py-0.5 rounded text-[10px]", children: photo.id }),
          photo.issue && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-2 right-2 bg-red-600 text-white px-2 py-0.5 rounded text-[10px] animate-pulse", children: "⚠️ Issue" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 pt-1", children: photo.tags.map((t, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold bg-slate-100 border border-slate-200 px-1.5 py-0.2 rounded text-slate-600 font-mono", children: t }, idx)) })
        ] })
      ] }, photo.id)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "AI Visual Log Inspector" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-36 bg-secondary/30 border border-border rounded-2xl flex items-center justify-center font-mono text-slate-400 text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-400 font-mono", children: [
                "Uploaded on ",
                selectedPhoto.date,
                " via WhatsApp"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border font-mono text-xs leading-relaxed text-slate-600", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-700 block uppercase tracking-wider text-[10px] mb-1", children: "AI Progress Assessment:" }),
              selectedPhoto.note
            ] }),
            selectedPhoto.issue && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-red-200 bg-red-50/20 text-red-700 text-xs animate-pulse", children: [
              "⚠️ ",
  ...
  const renderCost = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Project Budget", value: `₹${(calculatedCosts.totalBudget / 1e7).toFixed(2)}Cr`, desc: "Approved baseline", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Spent to Date", value: `₹${(calculatedCosts.totalSpent / 1e7).toFixed(2)}Cr`, desc: "Accounts invoices paid", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Projected Final Cost", value: `₹${(calculatedCosts.totalProjected / 1e7).toFixed(2)}Cr`, desc: "Cost-to-complete forecast", color: "text-amber-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Projected Gross Margin", value: `${calculatedCosts.margin}%`, desc: "Original: 45.6%", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Budget Variance", value: `+₹${(calculatedCosts.totalVariance / 1e5).toFixed(1)}L`, desc: "Projected overrun", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 border border-border bg-card space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Scenario Sensitivity Analysis Modelling" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display", children: "Margin Sensitivity Summary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold text-slate-600", children: [
  ...
  const renderPossession = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Units Handover", value: "240", desc: "Dec 2026 scheduling", color: "text-slate-800" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Snag Audited Units", value: "38", desc: "38 pre-possessions complete", color: "text-emerald-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Ready for Handover", value: "24", desc: "Snag-free + payment clear", color: "text-blue-700" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Blocked handovers", value: "12", desc: "Payment/snag issues pending", color: "text-red-600" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-red-50 border border-red-200 rounded-xl text-xs flex items-center gap-3 font-semibold text-red-600", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 bg-background font-medium text-foreground", children: possessions.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedPossession(row), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedPossession.id === row.id ? "bg-secondary/20 font-bold" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400 font-mono font-normal", children: [
                "Slot: ",
                row.date
              ] })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-1.5 py-0.2 rounded font-mono ${statusBadge(row.payment)}`, children: row.payment }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-mono font-bold", children: [
              row.snagsResolved,
              " / ",
              row.snagsTotal
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-slate-500 font-display", children: "Unit Handover Card" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-extrabold px-2 py-0.5 rounded font-mono ${statusBadge(selectedPossession.status)}`, children: selectedPossession.status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border font-mono text-xs space-y-1.5 text-slate-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
          ...
          selectedPossession.unit === "A-403" && selectedPossession.snagsTotal > selectedPossession.snagsResolved && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-slate-400 block border-b border-border pb-0.5", children: "Snag Checklist (1 Open item)" }),
            snagChecklist.map((sc, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 rounded bg-background border border-border/50 text-xs flex justify-between font-mono", children: [
