...
import { j as Route$2 } from "./router-DjkPPp1r.mjs";
import { n as ChevronLeft, b as ArrowRight, t as Clock, l as Check, A as Activity, a2 as TriangleAlert, f as Building, F as FileText, Z as Sparkles, u as Download, $ as SquareCheckBig, _ as Square } from "../_libs/lucide-react.mjs";
...
const dataHealthModules = [{
  ...
  id: "M6.3",
  name: "M6.3 — RERA Compliance",
  type: "Deadline calendar",
  sync: "18/01/2025 09:00 AM",
  status: "Live"
}];
...
const inventorySummary = [{
  ...
  avgDays: 94,
  action: "Escalate",
  color: "text-[#D85A30] animate-pulse"
}, {
  id: "inv-6",
  ...
  const renderDashboardOverview = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Reports Delivered (Month)", value: "47", desc: "Total dispatches", color: "text-[#2E86AB]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Forecast Accuracy", value: "84%", desc: "Trailing 30-day actuals", color: "text-[#1D9E75]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Channels Tracked", value: "10", desc: "Ad platforms + portals", color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Forecasted Revenue (30D)", value: "₹1.84 Cr", desc: "Weighted projections", color: "text-[#1D9E75]" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4 border-b border-border/40 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none h-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: reportDeliveryLog.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono text-[10px]", children: log.channel }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono text-slate-400", children: log.time }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100 font-mono", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto h-[280px] space-y-2 pr-1 scrollbar-none", children: dataHealthModules.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-xl border border-border/60 bg-background flex items-center justify-between text-xs transition-colors hover:bg-secondary/15", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-semibold", children: mod.type })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `inline-flex items-center gap-1 text-[9px] font-extrabold font-mono px-2 py-0.5 rounded ${mod.status === "Live" ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-amber-50 text-amber-600 border border-amber-100"}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[8.5px] font-mono text-slate-400 mt-1", children: [
                "Sync: ",
                mod.sync.split(" ")[1]
              ] })
            ] })
  ...
  const renderDailyReport = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-4 border border-border bg-card p-4 rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-r border-border/40 last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Leads Received" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: [
            teamSummary.leads,
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-500 text-[10px]", children: teamSummary.leadsDelta })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border/40 last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Leads Contacted" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border/40 last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Contact Rate" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:border-r border-border/40 last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Site Visits Done" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-base font-bold text-foreground font-mono mt-1", children: [
            teamSummary.visits,
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-500 text-[10px]", children: teamSummary.visitsDelta })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-bold uppercase tracking-wider font-display", children: "Daily Bookings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-base font-bold text-[#1D9E75] font-mono mt-1", children: [
            teamSummary.bookings,
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-semibold", children: [
              "(",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-8 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-slate-400 font-mono", children: "Last updated today at 6:45 PM" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: agentScorecards.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `p-4 border transition-all duration-300 flex flex-col justify-between h-48 bg-card ${item.isStar ? "border-amber-400/80 shadow-[0_4px_16px_rgba(232,168,56,0.06)]" : item.hasAlert ? "border-[#D85A30]/60" : "border-border/60 hover:border-slate-400"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  item.isStar && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] bg-amber-50 text-amber-700 font-extrabold px-1.5 py-0.5 rounded-full border border-amber-100 flex items-center gap-0.5", children: "⭐ STAR" }),
                  item.hasAlert && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] bg-red-50 text-[#D85A30] font-extrabold px-1.5 py-0.5 rounded-full border border-red-100 flex items-center gap-0.5", children: "⚠️ ALERT" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-mono font-bold px-2 py-0.5 rounded ${item.isStar ? "bg-amber-100 text-amber-800" : "bg-secondary text-slate-600"}`, children: item.rank })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-xs font-mono py-1 border-y border-border/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-muted-foreground uppercase font-sans font-bold", children: "Leads" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground mt-0.5", children: item.leads })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-muted-foreground uppercase font-sans font-bold", children: "Calls (C/A)" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-muted-foreground uppercase font-sans font-bold", children: "Visits" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8.5px] text-muted-foreground font-bold uppercase", children: "Revenue Generated" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedAgentMsg(item.agent), className: "h-6 px-2 rounded bg-secondary hover:bg-ink hover:text-cream text-[9px] font-bold transition-all border border-border/50 uppercase tracking-widest", children: "Preview WA" }),
                item.hasAlert && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedAgentAlert(item.agent), className: "h-6 px-2 rounded bg-red-50 hover:bg-[#D85A30] hover:text-white text-[#D85A30] text-[9px] font-bold transition-all border border-red-200 uppercase tracking-widest animate-pulse", children: "Alert Detail" })
              ] })
            ] })
          ] }, item.agent)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 font-display mb-3 border-b border-border/40 pb-2", children: "Team Funnel Conversion Trend (7 Days)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3.5", children: [{
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10.5px] font-mono text-slate-400 font-bold", children: [
                  spark.current,
                  " today"
                ] })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 font-display border-b border-border/40 pb-2", children: "Report Transmission Logs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-slate-500 border-b border-border/30 pb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "WhatsApp Broadcast Group" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-600 font-mono text-[10.5px] font-extrabold flex items-center gap-1", children: "✅ Sent 7:00 PM" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-slate-500 border-b border-border/30 pb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Management Email Queue" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-600 font-mono text-[10.5px] font-extrabold flex items-center gap-1", children: "✅ Sent 7:01 PM" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-slate-500 pb-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-600 font-mono text-[10.5px] font-extrabold flex items-center gap-1", children: "✅ Saved (4.2MB)" })
              ] })
            ] })
          ] })
        ] })
      ...
      selectedAgentMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-ink/40 backdrop-blur-sm flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-md p-5 border border-border bg-card shadow-2xl space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3.5 bg-secondary/35 rounded-xl border border-border/60 font-mono text-[10.5px] text-foreground leading-relaxed whitespace-pre-wrap", children: `📊 *Fortiv Solutions — Daily Performance Report*
...
Powered by Fortiv AI Command Center` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-slate-400 font-semibold text-center uppercase tracking-widest", children: "Dispatched via WhatsApp Business Cloud API" })
      ] }) }),
      selectedAgentAlert && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-ink/40 backdrop-blur-sm flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-md p-5 border border-border bg-card shadow-2xl space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-[#D85A30]/40 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-bold text-xs uppercase text-[#D85A30] tracking-wider font-display flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3.5 bg-red-50/40 rounded-xl border border-red-200 font-mono text-[10.5px] text-[#D85A30] leading-relaxed whitespace-pre-wrap", children: `⚠️ *Manager Alert — 20 January 2025*
...
Recommend: Check in before tomorrow morning.` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          }, className: "flex-1 h-8 rounded bg-ink hover:bg-ink/90 text-cream text-[10px] font-bold uppercase tracking-widest", children: "Nudge Agent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedAgentAlert(null), className: "h-8 px-4 rounded border border-border hover:bg-secondary text-slate-500 text-[10px] font-bold uppercase tracking-widest", children: "Dismiss Alert" })
        ] })
      ] }) })
    ] });
  };
  ...
  const renderForecast = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      hasShortfallRisk && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-[#D85A30]/10 border border-[#D85A30]/30 rounded-xl text-[#D85A30] flex items-center justify-between text-xs font-semibold animate-bounce", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold font-mono", children: "CRITICAL STAGE" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "30-day Revenue Forecast", value: formatInr(forecastMetrics.r30, "Cr"), desc: `${forecastMetrics.b30} bookings`, color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "60-day Revenue Forecast", value: formatInr(forecastMetrics.r60, "Cr"), desc: `${forecastMetrics.b60} bookings`, color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "90-day Revenue Forecast", value: formatInr(forecastMetrics.r90, "Cr"), desc: `${forecastMetrics.b90} bookings`, color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "ML Forecast Accuracy", value: "84%", desc: "Trailing 6M Average", color: "text-[#1D9E75]" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4 border-b border-border/40 pb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-[9px] font-bold uppercase tracking-widest text-slate-400 font-display", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto scrollbar-none py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "min-w-[450px] w-full h-[220px]", viewBox: "0 0 500 220", children: [
            [0, 5, 10, 15, 20].map((grid, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x: "35", y: y + 3, textAnchor: "end", className: "text-[8.5px] font-mono fill-slate-400 font-bold", children: [
                  grid,
                  " Cr"
                ] })
              ] }, idx);
            ...
            [{
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { className: "group/bar", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: x + barW / 2, y: "190", textAnchor: "middle", className: "text-[10px] font-bold fill-foreground", children: bar.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x: x + barW / 2, y: valY - 12, textAnchor: "middle", className: "text-[9.5px] font-mono font-bold fill-primary opacity-0 group-hover/bar:opacity-100 transition-opacity", children: [
                  "₹",
                  bar.val.toFixed(2),
                  "Cr"
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border/40 pb-2", children: "Scenario Modelling Simulation" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10.5px] text-slate-400 font-semibold leading-relaxed mt-2", children: "Toggle macroeconomic properties and sales variables to test forecast impacts in real time." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-1 border-t border-border/40 mt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9.5px] text-slate-400 font-semibold", children: "Uplifts volume +28%, margin drops -3%" })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-1 border-t border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-600 font-bold", children: "Project RERA Extension Delay" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9.5px] text-slate-400 font-semibold", children: "Deflates quarterly bookings by -22%" })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-1 border-t border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9.5px] text-slate-400 font-semibold", children: "Contracts price-sensitive buyers (-8% impact)" })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2 border-t border-border/40 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono font-extrabold text-slate-400 uppercase tracking-widest", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-6 p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display mb-3 border-b border-border/40 pb-2", children: "Pipeline Stage Weightings & Forecast Contributions" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-6 p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display mb-3 border-b border-border/40 pb-2", children: "Model Historical Accuracy Log" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none max-h-[220px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-[9px] uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
  ...
  const renderInventory = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      ...
      !orphanReassigned && selectedProject === "proj-1" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-red-50 border border-red-200 rounded-xl text-foreground flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs leading-relaxed font-semibold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#D85A30] font-bold flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 animate-pulse" }),
            " Agent Orphan Alert — Ankit Shah Reassigned"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-[10.5px] font-medium", children: "Unit 604 (2BHK, prospect: Amit Desai, score: 61) is currently unassigned in the Vesu territory." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          setOrphanReassigned(true);
          alert("Orphaned unit successfully reassigned to Priya Rana.");
        }, className: "h-7 px-3 bg-ink hover:bg-ink/90 text-cream text-[10px] font-bold uppercase tracking-widest rounded transition-all shrink-0 active:scale-95", children: "Reassign to Priya Rana" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card min-h-[460px] flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border/40 pb-2 mb-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2.5 text-[9px] font-bold font-mono", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded bg-[#D85A30]" }),
                  " Available (",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-1.5 max-h-[350px] overflow-y-auto pr-1 scrollbar-none", children: heatmapGrid.map((unit) => {
              ...
              const bg = unit.status === "sold" ? "bg-emerald-600 hover:bg-emerald-700 text-white" : unit.status === "negotiation" ? "bg-amber-500 text-white animate-pulse" : unit.status === "held" ? "bg-slate-400 text-white" : "bg-red-50 text-[#D85A30] border border-red-200 hover:bg-red-100/50";
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => handleCellClick(unit.id), className: `h-9 rounded-lg flex flex-col justify-center items-center cursor-pointer transition-all duration-300 text-[10px] font-mono font-bold select-none ${bg} ${isSelected ? "ring-2 ring-primary ring-offset-2 scale-95" : ""}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8.5px] font-mono text-slate-400 text-center border-t border-border/40 pt-3", children: "*Tower grid represents G+14 structural layout snapshot. Delayed updates sync every 24 hours." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card min-h-[220px] flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 font-display border-b border-border/40 pb-2 mb-3", children: "Unit Properties Panel" }),
              activeUnitDetail ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-xs font-semibold", children: [
                ...
                activeUnitDetail.daysOnMarket >= 45 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-amber-50 border border-amber-200 rounded-lg text-slate-700 text-[10.5px]", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 font-medium", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-mono text-[#D85A30]", children: "₹4,750–₹4,900/sq ft" }),
                    "."
                  ] })
                ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-medium max-w-[200px] mx-auto", children: "Select any unit grid box to inspect its sales metrics and velocity alerts." })
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 font-display border-b border-border/40 pb-2 mb-3", children: "Incentive Schemes Effectiveness" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display mb-3 border-b border-border/40 pb-2", children: "Average Days on Market by Configuration" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-full max-w-[340px] h-[130px]", viewBox: "0 0 300 130", children: [
            [{
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "75", y: y + 11, textAnchor: "end", className: "text-[9px] font-bold fill-foreground", children: bar.label }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x: 85 + barL + 8, y: y + 11, className: "text-[9px] font-mono font-extrabold fill-slate-700", children: [
                  bar.days,
                  "d"
                ] })
              ] }, bar.label);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display mb-3 border-b border-border/40 pb-2", children: "Slow-Moving Inventory Warnings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none max-h-[160px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-[9px] uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
  ...
  const renderInvestorReport = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Reports Generated (Q1)", value: "4 reports", desc: "Automatic dispatches", color: "text-[#2E86AB]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Next Scheduled Run", value: "01/03 09:00", desc: "Monthly recurring", color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Distribution Pool", value: "24 LPs", desc: "Syncing portals", color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "LP Email Open Rate", value: "87.5%", desc: "Trailing 3 runs", color: "text-[#1D9E75]" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col justify-between min-h-[460px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xs uppercase text-slate-500 tracking-wider font-display border-b border-border/40 pb-2", children: "Dossier Compilation Settings" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10.5px] text-slate-400 font-semibold leading-relaxed mt-2", children: "Select parameters to extract real-time pipeline records and compile investor documents." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3.5 text-xs font-semibold", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-t border-border/40 mt-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-600 font-bold", children: "Auto-Release to LP Portals" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9.5px] text-slate-400 font-semibold", children: "Distribute instantly upon compile, skipping approvals" })
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card min-h-[460px] flex flex-col justify-center relative", children: [
          ...
          generationProgress >= 0 && generationProgress <= 100 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-8 space-y-4 animate-in fade-in duration-300", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9.5px] font-mono text-slate-400 uppercase tracking-wider mt-3 font-semibold", children: generationStep })
            ] })
          ] }),
          generationProgress === 101 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in slide-in-from-bottom duration-500 h-full flex flex-col justify-between", children: [
            ...
            }].map((tab2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActivePdfTab(tab2.id), className: `h-7 px-2.5 rounded-lg text-[10.5px] font-bold border transition-all ${activePdfTab === tab2.id ? "bg-ink border-ink text-cream" : "bg-background border-border text-slate-500 hover:bg-muted"}`, children: tab2.label }, tab2.id)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-secondary/35 rounded-xl border border-border/60 text-xs text-slate-700 leading-relaxed overflow-y-auto max-h-[260px] scrollbar-none font-sans font-medium flex-1", children: [
              activePdfTab === "cover" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6 space-y-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] font-mono text-slate-400", children: [
                  "Project: ",
                  demoProjects.find((p) => p.id === reportProject)?.name.split(",")[0]
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-slate-400 mt-6", children: [
              ...
              activePdfTab === "exec" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-foreground text-sm border-b border-border/40 pb-1 uppercase font-display", children: "Executive Summary" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "font-bold text-[#1A3C5E] mt-2", children: "Key Highlights:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "list-disc pl-4 space-y-1 text-[10.5px]", children: [
              ...
              activePdfTab === "sales" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-foreground text-sm border-b border-border/40 pb-1 uppercase font-display", children: "Sales & Absorption Status" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] leading-relaxed", children: "Inventory velocity analysis highlights normal sales runs in the 2BHK family layouts, whereas 3BHK premium inventories show a minor seasonal slowdown, currently mitigated by parking promotion schemes." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 border border-border bg-background rounded-lg text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground block uppercase font-bold", children: "Total Sold Units" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold font-mono text-[#1D9E75]", children: "108 Units (69.2%)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 border border-border bg-background rounded-lg text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground block uppercase font-bold", children: "Remaining Available" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold font-mono text-[#D85A30]", children: "48 Units (30.8%)" })
                  ] })
                ] })
              ] }),
              activePdfTab === "financials" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-foreground text-sm border-b border-border/40 pb-1 uppercase font-display", children: "Financial Metrics Overview" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px]", children: "Project cash reserves are stable, with collections tracking ahead of the construction billing schedule. Escrow accounts have been audited in compliance with regulatory RERA standards." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-[10.5px] border-t border-border/30 pt-2 font-mono", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[#1D9E75] font-extrabold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/40 font-medium text-foreground bg-background", children: mockDistributionLog.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono font-bold text-[#0E86E9]", children: log.opened }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-600 font-mono text-[10px] font-extrabold bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100", children: "✅ Synced M10" }) })
          ] }, log.id)) })
        ] }) })
      ] })
    ] });
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 overflow-hidden border border-border bg-card flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 bg-secondary/30 border-b border-border flex justify-between items-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-slate-400 font-mono font-bold", children: "Sorted by Cost-per-booking (CPB)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: channelPerformanceTable.map((ch) => {
                ...
                const roiClass = ch.roi === Infinity ? "bg-emerald-100 text-emerald-800" : ch.roi >= 5 ? "bg-emerald-50 text-[#1D9E75] border border-emerald-100" : ch.roi >= 1.5 ? "bg-amber-50 text-amber-700 border border-amber-100" : "bg-red-50 text-[#D85A30] border border-red-100";
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setExpandedChannel(isExpanded ? null : ch.channel), className: "hover:bg-secondary/15 cursor-pointer border-b border-border/30 last:border-none", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-bold flex items-center gap-1.5", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] text-slate-400", children: "▶" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-[11px]", children: ch.spend > 0 ? formatInr(ch.spend) : "₹0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-[11px]", children: ch.leads }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-[#1D9E75] font-extrabold", children: ch.bookings }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3 font-mono text-[11px] font-bold", children: ch.spend > 0 && hasBookings ? formatInr(ch.cpb) : "—" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-[10px] font-extrabold font-mono ${roiClass}`, children: ch.roi === Infinity ? "∞" : `${ch.roi}x` }) })
                  ] }, ch.channel),
                  isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, className: "px-4 py-3 bg-secondary/15 border-b border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 animate-in fade-in duration-300", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-500", children: "Campaign Level Drill-down" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-[11px] border border-border/60 bg-background rounded-lg overflow-hidden", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/20 text-muted-foreground text-[8px] uppercase font-mono", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8.5px] font-mono text-slate-400 text-center py-2.5 border-t border-border/40 bg-secondary/10", children: "*Campaign tracking integrations pull spend values from Facebook Ads Manager API and Google Ads API daily." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 font-display border-b border-border/40 pb-2 mb-3", children: "AI Budget Recommendations" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-sky-50/50 border border-sky-200 rounded-xl text-xs space-y-3 leading-relaxed font-semibold", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 font-medium text-slate-700", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#D85A30] font-bold block", children: "🔴 REVIEW / DOWNGRADE:" }),
                  "• Housing.com: ₹90K spend, 0 bookings. Downsize subscription tier or pause allocation for 30 days."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-sky-300/40 pt-2 font-bold text-primary text-[10.5px]", children: "Total potential reallocation: Reallocate ₹90K from Housing.com to Referrals. Est: +2.8 bookings/month." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-bold uppercase tracking-wider text-slate-500 font-display border-b border-border/40 pb-2", children: "Spend Allocation Simulator" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-secondary/40 border border-border/60 rounded-xl space-y-1 text-center font-mono mt-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] uppercase tracking-wider text-slate-400 font-sans font-bold", children: "Projected Results" }),
  ...
  const [actionsChecked, setActionsChecked] = reactExports.useState([false, false, false, false, false]);
  ...
  const priorityActionsList = [{
    ...
    text: "Collect construction records for Greenview Heights QPR filing due Jan 31.",
    reason: "RERA compliance deadline",
    severity: "border-l-4 border-l-[#1A3C5E]"
  }];
  ...
  const renderExecutiveBrief = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Briefings Delivered (YTD)", value: "22", desc: "Monday dispatches", color: "text-[#2E86AB]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Last brief compiled", value: "20 Jan 07:22", desc: "Monday W03", color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Next Compilation Run", value: "5 days 16 hrs", desc: "Scheduled 27 Jan", color: "text-[#1A3C5E]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Executive Open Rate", value: "100%", desc: "All directors checked", color: "text-[#1D9E75]" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card min-h-[460px] flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between border-b border-border/40 pb-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold text-xs text-foreground font-display flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-4 w-4 text-primary" }),
              " AI Compiled Weekly Briefing Preview (Week W03)"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 border-b border-border/30 pb-2 mb-3", children: [{
              id: "numbers",
              ...
              id: "compliance",
              label: "RERA & Finance"
            }].map((sec) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setBriefSection(sec.id), className: `h-6 px-2.5 rounded-lg text-[10px] font-bold border transition-all ${briefSection === sec.id ? "bg-ink border-ink text-cream" : "bg-background border-border text-slate-500 hover:bg-muted"}`, children: sec.label }, sec.id)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 rounded-xl border border-border/60 text-xs text-slate-700 leading-relaxed font-sans font-medium h-[220px] overflow-y-auto scrollbar-none", children: [
              briefSection === "numbers" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "font-bold text-foreground uppercase text-[10.5px] font-display border-b border-border/20 pb-0.5", children: "Week in Numbers (13–19 Jan 2025)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-[11px] border border-border/30 bg-background rounded overflow-hidden", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/20 text-muted-foreground text-[8px] font-mono", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              ...
              briefSection === "deals" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "font-bold text-foreground uppercase text-[10.5px] font-display border-b border-border/20 pb-0.5", children: "Deal Highlights" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10.5px]", children: [
              ...
              briefSection === "compliance" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "font-bold text-foreground uppercase text-[10.5px] font-display border-b border-border/20 pb-0.5", children: "RERA deadlines & Finance Snapshot" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10.5px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Gujarat RERA compliance:" }),
                  " The QPR filing deadline for Greenview Heights is 31 January (11 days remaining). Construction progress logs need to sync from M9."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10.5px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Finance:" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-3 border-t border-border/40", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col justify-between min-h-[460px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b border-border/40 pb-2 mb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono font-extrabold text-[#1D9E75]", children: "MTD TRACKING" })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 pt-1", children: priorityActionsList.map((action, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => handleActionToggle(idx), className: `p-2 rounded-lg border border-border/60 bg-background text-[11px] font-semibold cursor-pointer transition-all hover:bg-secondary/15 flex items-start gap-2.5 ${action.severity} ${isChecked ? "opacity-60 line-through decoration-slate-400" : ""}`, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5 leading-snug", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8.5px] font-mono text-slate-400 font-extrabold uppercase", children: action.reason })
                ] })
              ] }, idx);
            }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-3 flex justify-between items-center text-[10px] font-mono text-slate-400", children: [
  ...
  const renderMenuSelection = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 animate-in fade-in duration-300", children: submodulesList.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setActiveTab(mod.id), className: "p-5 border border-border/70 hover:border-ink hover:shadow-[0_4px_20px_rgba(11,31,51,0.04)] transition-all duration-300 cursor-pointer flex flex-col justify-between group h-48 bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100 font-mono", children: [
