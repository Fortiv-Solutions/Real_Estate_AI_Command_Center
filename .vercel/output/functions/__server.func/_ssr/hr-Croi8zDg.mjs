...
import { e as Route$7 } from "./router-CIivQbm3.mjs";
import { n as ChevronLeft, b as ArrowRight, A as Activity, a1 as TrendingUp, U as Send, r as CircleCheckBig, t as Clock, R as RefreshCw, u as Download, a2 as TriangleAlert, d as Award } from "../_libs/lucide-react.mjs";
...
function StatBox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 flex flex-col justify-between min-h-24 border border-border bg-card", children: [
...
const scoreColor = (score) => score >= 80 ? "text-emerald-600" : score >= 60 ? "text-[#2E86AB]" : score >= 40 ? "text-[#E8A838]" : "text-[#D85A30]";
...
function RenderMenu({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 animate-in fade-in duration-300", children: list.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => onSelect(mod.id), className: "submodule-card p-5 cursor-pointer flex flex-col justify-between group h-44", children: [
...
function RenderOverview({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Open Positions", value: "4", desc: "Roles being hired", color: "text-[#2E86AB]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Candidates in Pipeline", value: "38", desc: "Active across stages", color: "text-[#1A3C5E]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Joining This Month", value: "3", desc: "Offer accepted", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Payroll Processed", value: "₹14.2L", desc: "Jan 2025 — Done ✓", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Pending HR Actions", value: "7", desc: "Awaiting attention", color: "text-[#E8A838]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border/40 pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onNavigate("resume-screening"), className: "text-[9px] font-bold text-primary hover:underline font-mono", children: "View Candidates →" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: funnelData.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-36 text-slate-500 font-semibold shrink-0 text-[10.5px]", children: row.stage }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 font-mono font-bold text-foreground text-right text-[11px]", children: row.count })
        ] }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 pt-2 border-t border-border/30 text-[9.5px] font-mono text-slate-400", children: "142 resumes screened · 12 shortlisted · 130 rejected — processed in 13 minutes" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border/40 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-bold uppercase tracking-widest text-slate-500 font-display flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3.5 w-3.5 text-[#1D9E75]" }),
            " Team Performance Snapshot"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onNavigate("performance"), className: "text-[9px] font-bold text-primary hover:underline font-mono", children: "Full View →" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 max-h-[260px] overflow-y-auto scrollbar-none pr-1", children: employees.map((emp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-2.5 rounded-xl border flex items-center gap-3 ${scoreBg(emp.score)}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-10 w-10 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute inset-0 flex items-center justify-center text-[10px] font-extrabold font-mono ${scoreColor(emp.score)}`, children: emp.score })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-foreground text-xs flex items-center gap-1.5", children: [
              emp.name,
              emp.score >= 80 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-bold bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded-full border border-emerald-200 animate-pulse", children: "⭐ Top" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9.5px] text-slate-500 font-medium", children: emp.role })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono border ${performanceLabel(emp.label)}`, children: emp.label })
        ] }, emp.id)) })
      ] })
    ] })
  ] });
...
function RenderResumeScreening() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Applications", value: "142", desc: "All sources", color: "text-[#1A3C5E]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Shortlisted (AI)", value: "12", desc: "Score ≥ 65", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Rejected", value: "130", desc: "Below threshold", color: "text-[#D85A30]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Processing Time", value: "13 min", desc: "For 142 resumes", color: "text-[#2E86AB]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: ["All", "Shortlisted", "Borderline", "Rejected"].map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `h-7 px-3 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-all ${i === 0 ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: f }, f)) }),
      bulkSelected.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
        ...
        setBulkSelected([]);
      }, className: "h-7 px-3 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-[10px] font-bold uppercase tracking-widest ml-auto flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-7 p-0 overflow-hidden border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border text-[10px] font-bold uppercase text-slate-500 font-display", children: [
          "Ranked Shortlist — ",
          role
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: candidates.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelectedCandidate(c), className: `hover:bg-secondary/15 cursor-pointer transition-colors ${selectedCandidate.rank === c.rank ? "bg-secondary/20" : ""}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: c.status === "Shortlisted" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: (e) => {
              e.stopPropagation();
              toggleBulk(c.rank);
            }, className: `h-4 w-4 rounded border flex items-center justify-center transition-all ${bulkSelected.includes(c.rank) ? "bg-ink border-ink text-cream" : "border-border hover:border-ink"}`, children: bulkSelected.includes(c.rank) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-bold", children: "✓" }) }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-mono font-extrabold text-[11px] ${scoreColor(c.score)}`, children: c.score })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono ${candidateStatusBadge(c.status)}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border/40 pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-extrabold px-2 py-0.5 rounded font-mono ${candidateStatusBadge(selectedCandidate.status)}`, children: selectedCandidate.status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-slate-400 font-semibold", children: selectedCandidate.current })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/30 rounded-xl p-3 font-mono text-[10px] leading-relaxed text-foreground space-y-1 border border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold uppercase tracking-wider text-slate-400 text-[9px] mb-2", children: "WHY THIS SCORE:" }),
            ...
            selectedCandidate.red.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[#D85A30]", children: [
              "✗ ",
              r
            ] }, i))
          ] }),
          selectedCandidate.green.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400", children: "Green Flags" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: selectedCandidate.green.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9.5px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 px-2 py-0.5 rounded-full", children: g }, i)) })
          ] }),
          selectedCandidate.red.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400", children: "Red Flags" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: selectedCandidate.red.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9.5px] font-bold bg-red-50 text-[#D85A30] border border-red-200 px-2 py-0.5 rounded-full", children: r }, i)) })
          ] }),
...
function RenderInterviewScheduler() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Invites Sent This Week", value: "6", desc: "All rounds", color: "text-[#2E86AB]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Confirmed", value: "2", desc: "Candidates confirmed", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "No Shows", value: "0", desc: "This week", color: "text-[#1A3C5E]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Avg Response Time", value: "3.2 hrs", desc: "Invite to confirmation", color: "text-[#E8A838]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      ["All", "Invite Sent", "Confirmed", "Completed", "No Show"].map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedStage(s), className: `h-7 px-3 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-all ${selectedStage === s ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: s }, s)),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-[9.5px] font-mono font-bold text-emerald-600 flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-7 grid grid-cols-4 gap-3", children: kanbanStages.map((stage) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[9px] font-extrabold uppercase tracking-widest text-slate-400 font-display border-b border-border/40 pb-1.5", children: [
          stage,
          " ",
        ...
        kanbanData[stage].map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-2.5 border border-border/70 bg-card text-xs space-y-1", children: [
          ...
          c.outcome && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-[9.5px] font-bold ${c.outcome.includes("✅") ? "text-emerald-600" : "text-[#D85A30]"}`, children: c.outcome })
        ] }, i))
      ] }, stage)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-5 p-4 border border-border bg-card flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-bold uppercase tracking-widest text-slate-500 font-display border-b border-border/40 pb-2", children: "Week Schedule — 13–17 Jan 2025" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 overflow-y-auto max-h-[260px] scrollbar-none pr-1", children: interviews.map((iv, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-2.5 rounded-xl border text-xs flex items-start gap-2.5 ${iv.status === "Completed" ? "border-emerald-200 bg-emerald-50/30" : iv.status === "Confirmed" ? "border-blue-200 bg-blue-50/20" : iv.status.includes("Pending") ? "border-slate-200 bg-slate-50/20" : "border-border bg-background"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 text-center min-w-[54px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono font-bold text-foreground text-[10px]", children: iv.date }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[9px] text-slate-400", children: iv.time })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: iv.candidate }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[9.5px] text-slate-500 font-semibold", children: [
              iv.round,
              " · ",
              iv.interviewer
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono shrink-0 ${candidateStatusBadge(iv.status)}`, children: iv.status })
        ] }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-2", children: "WhatsApp Slot Offer Preview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#ECF3EE] rounded-xl p-3 text-[10.5px] leading-relaxed text-slate-700 font-medium border border-emerald-100", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right text-[9px] text-slate-400 mt-1", children: "14:31 ✓✓" })
          ] })
        ] })
      ] })
    ] })
...
function RenderOnboarding() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Active Onboardings", value: "3", desc: "Joining in Jan 2025", color: "text-[#2E86AB]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Avg Doc Completion", value: "87%", desc: "Across active joiners", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "IT Setup Pending", value: "1", desc: "Nikhil Mehta", color: "text-[#E8A838]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Pending Reminders Sent", value: "3", desc: "For docs collection", color: "text-[#1A3C5E]" })
    ] }),
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setExpanded(isOpen ? null : emp.name), className: "p-4 cursor-pointer hover:bg-secondary/10 flex items-center gap-4 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-12 w-12 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute inset-0 flex items-center justify-center text-[10px] font-extrabold font-mono text-foreground", children: [
              emp.docs,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono border ${emp.status === "Month 1" ? "bg-emerald-50 text-emerald-700 border-emerald-100" : emp.status === "Week 1" ? "bg-blue-50 text-blue-700 border-blue-100" : "bg-amber-50 text-amber-700 border-amber-100"}`, children: emp.status })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-slate-500 font-semibold", children: [
              emp.role,
              " · ",
              emp.id,
              " · Joining: ",
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 pt-0 border-t border-border/40 animate-in fade-in duration-200 grid grid-cols-2 gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-2", children: "Document Collection" }),
            ...
            emp.docsPending.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`WhatsApp reminder sent to ${emp.name} for ${emp.docsPending.length} pending documents.`), className: "mt-2 h-7 px-3 rounded-lg border border-amber-300 text-amber-700 bg-amber-50 hover:bg-amber-100 text-[9.5px] font-bold uppercase tracking-widest", children: "Send Reminder" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-2", children: "Setup Checklist" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 text-xs font-semibold", children: [{
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-bold font-mono text-[10px] ${item.ok ? "text-emerald-600" : "text-amber-600 animate-pulse"}`, children: item.val })
            ] }, i)) }),
            emp.status === "Pre-joining" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`Day 1 automations triggered for ${emp.name}!`), className: "mt-3 w-full h-7 rounded-lg bg-ink hover:bg-ink/90 text-cream text-[9.5px] font-bold uppercase tracking-widest transition-all", children: "Mark Day 1 Complete" })
          ] })
        ] })
      ] }, emp.id);
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-2", children: 'Automated "Your First Day" WhatsApp — Nikhil Mehta' }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#ECF3EE] rounded-xl p-4 text-[10.5px] leading-relaxed text-slate-700 font-medium border border-emerald-100 max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-slate-800 mb-1", children: "Fortiv Solutions HR ·" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right text-[9px] text-slate-400 mt-1", children: "Sent automatically on 19/01/2025 ✓✓" })
      ] })
    ] })
  ] });
}
function RenderPayroll() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Employees", value: "28", desc: "January 2025", color: "text-[#1A3C5E]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Gross Payroll", value: "₹14.2L", desc: "All employees", color: "text-[#2E86AB]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Net Disbursement", value: "₹12.07L", desc: "After deductions", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Total Payroll Cost", value: "₹15.47L", desc: "Incl. employer contrib.", color: "text-[#E8A838]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-0 overflow-hidden border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-secondary/35 border-b border-border flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            !runDone && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: triggerPayroll, disabled: runProgress >= 0 && runProgress < 100, className: "h-7 px-3 rounded-lg bg-ink hover:bg-ink/90 text-cream text-[10px] font-bold uppercase tracking-widest disabled:opacity-50 flex items-center gap-1.5 transition-all", children: [
            ...
            runDone && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-emerald-600 flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-3.5 w-3.5" }),
              "Tally Journal Pushed"
            ] })
          ] })
        ] }),
        runProgress >= 0 && runProgress < 100 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 bg-amber-50 border-b border-amber-200 text-[9.5px] font-mono text-amber-700 font-semibold animate-pulse", children: runStep }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-[9px] uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: payrollData.map((emp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3 font-mono text-[#D85A30]", children: [
              "-₹",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono ${emp.status.includes("✅") ? "bg-emerald-50 text-emerald-700 border border-emerald-100" : "bg-amber-50 text-amber-700 border border-amber-100 animate-pulse"}`, children: emp.status }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: emp.status.includes("✅") && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => alert(`Payslip for ${emp.name} — Jan 2025 downloaded.`), className: "h-6 px-2 rounded border border-border hover:bg-secondary text-[9px] font-bold text-slate-500 flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card font-mono text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center font-display font-bold text-sm uppercase tracking-widest text-foreground mb-3 border-b border-border/40 pb-2", children: "January 2025 Payroll Summary" }),
          [{
            l: "Total Employees",
            v: "28"
          }, {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] uppercase tracking-wider text-slate-400 font-sans font-bold mt-2 pt-2 border-t border-border/40 mb-1", children: "Employer Liabilities" }),
          [{
            l: "Employer PF (12%)",
            v: "₹1,02,600"
          }, {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 pt-2 border-t border-border/40 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-emerald-600 font-bold text-[10px]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [{
          ...
          l: "PT Challan",
          c: "amber"
        }].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => alert(`${b.l} downloaded.`), className: "h-8 rounded-lg border border-border hover:bg-secondary text-[9.5px] font-bold text-slate-600 uppercase tracking-widest flex items-center justify-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-3 w-3" }),
          " ",
          b.l
        ] }, b.l)) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-3", children: "Sample Payslip — Priya Rana (Jan 2025)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10.5px] text-foreground bg-secondary/30 rounded-xl p-4 border border-border/60 whitespace-pre max-w-xl", children: `╔══════════════════════════════════════════════════╗
...
function RenderPerformance() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
      ["This Week", "This Month", "Q1 2025"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPeriod(p), className: `h-7 px-3 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-all ${period === p ? "bg-ink text-cream border-ink" : "border-border text-slate-500 hover:bg-secondary"}`, children: p }, p)),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4", children: employees.map((emp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { onClick: () => setSelectedEmp(emp), className: `p-4 border cursor-pointer transition-all duration-200 hover:shadow-md flex flex-col items-center gap-2 ${selectedEmp.id === emp.id ? "border-ink shadow-[0_2px_12px_rgba(11,31,51,0.08)]" : "border-border"} bg-card`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9px] font-extrabold px-2 py-0.5 rounded-full border font-mono ${performanceLabel(emp.label)} ${emp.score >= 80 ? "animate-pulse" : ""}`, children: emp.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full text-[9.5px] font-mono text-slate-400 text-center", children: emp.revenue })
    ] }, emp.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-8 p-4 border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 border-b border-border/40 pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono border ${performanceLabel(selectedEmp.label)}`, children: selectedEmp.label })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-secondary/15 text-muted-foreground text-[9px] uppercase tracking-wider font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: [{
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-3 py-2.5 font-mono font-extrabold ${typeof row.v === "number" && row.v === 0 ? "text-[#D85A30]" : "text-foreground"}`, children: row.v }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono text-slate-400", children: row.b }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-3 py-2.5 font-mono font-bold text-sm ${row.t === "▲" ? "text-emerald-500" : row.t === "▼" ? "text-[#D85A30]" : "text-slate-400"}`, children: row.t })
          ] }, i)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "col-span-12 lg:col-span-4 p-4 border border-border bg-card", children: selectedEmp.score < 60 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-xl border border-amber-200 bg-amber-50/40 font-mono text-[10px] text-foreground leading-relaxed whitespace-pre-wrap", children: `⚠️ COACHING FLAG — ${selectedEmp.name}
...
➜ Role-play objection handling session` }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-3 rounded-xl border font-mono text-[10px] text-foreground leading-relaxed whitespace-pre-wrap ${selectedEmp.score >= 80 ? "border-emerald-200 bg-emerald-50/40" : "border-blue-200 bg-blue-50/20"}`, children: `✅ ${selectedEmp.score >= 80 ? "TOP PERFORMER" : "ON TRACK"}
...
function RenderTalentSourcing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Profiles Sourced (All)", value: "103", desc: "Across 4 open roles", color: "text-[#1A3C5E]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Shortlisted (AI)", value: "23", desc: "Score ≥ 65", color: "text-[#2E86AB]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Outreach Sent", value: "18", desc: "LinkedIn + WhatsApp", color: "text-[#E8A838]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Interested / Responded", value: "8", desc: "Ready to interview", color: "text-[#1D9E75]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9.5px] font-bold text-emerald-600 flex items-center gap-1.5 font-mono", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: (filtered.length ? filtered : sourcedCandidates).map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3.5 py-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: c.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9.5px] font-mono text-slate-400", children: c.loc })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9.5px] font-bold bg-secondary text-slate-600 border border-border px-2 py-0.5 rounded font-mono", children: c.platform }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-mono font-extrabold text-[11px] ${scoreColor(c.score)}`, children: c.score }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-bold px-2 py-0.5 rounded font-mono border ${c.outreach === "Message Sent" ? "bg-blue-50 text-blue-700 border-blue-100" : "bg-slate-50 text-slate-500 border-slate-200"}`, children: c.outreach }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-bold px-2 py-0.5 rounded font-mono border ${c.response === "Interested" ? "bg-emerald-50 text-emerald-700 border-emerald-100" : c.response === "No Response" ? "bg-amber-50 text-amber-700 border-amber-100" : "bg-slate-50 text-slate-400 border-slate-200"}`, children: c.response }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3.5 py-3", children: c.response === "Interested" ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`${c.name} added to hiring pipeline.`), className: "h-6 px-2 rounded bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-700 text-[9px] font-bold", children: "Add to Pipeline" }) : c.outreach === "Not Contacted" ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert(`LinkedIn outreach sent to ${c.name}.`), className: "h-6 px-2 rounded border border-border hover:bg-secondary text-[9px] font-bold text-slate-500", children: "Reach Out" }) : null })
          ] }, i)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-12 lg:col-span-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-3", children: "Open Roles Sourcing Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3.5", children: openRoles.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-2.5 rounded-xl border text-xs transition-all cursor-pointer ${selectedRole === r.role ? "border-ink bg-secondary/10" : "border-border bg-background hover:border-slate-300"}`, onClick: () => setSelectedRole(r.role), children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-1 text-center", children: [{
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8.5px] text-slate-400 font-semibold", children: s.l })
            ] }, s.l)) })
          ] }, i)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-3 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-2", children: "LinkedIn Outreach Template" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#EEF3F8] rounded-xl p-3 text-[10px] leading-relaxed text-slate-700 font-medium border border-blue-100", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right text-[9px] text-slate-400 mt-1", children: "Auto-sent · 10/01/2025" })
          ] })
        ] })
      ] })
    ] })
...
function RenderHrChatbot() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Queries This Month", value: "100", desc: "All channels", color: "text-[#1A3C5E]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Bot Resolved", value: "80%", desc: "Without HR intervention", color: "text-[#1D9E75]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Escalated to HR", value: "20", desc: "Complex / sensitive", color: "text-[#E8A838]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatBox, { label: "Avg Response Time", value: "< 3 sec", desc: "Chatbot reply", color: "text-[#2E86AB]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-12 lg:col-span-6 border border-border bg-card overflow-hidden flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#075E54] p-3 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/70 text-[9px] font-medium", children: "Online · 24/7" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: employee, onChange: (e) => setEmployee(e.target.value), className: "ml-auto bg-white/10 text-white text-[9px] rounded px-1.5 py-0.5 border border-white/20 outline-none font-bold", children: employees.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: e.name, children: e.name }, e.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-3 space-y-3 bg-[#ECE5DD]", children: messages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${msg.from === "bot" ? "justify-start" : "justify-end"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[80%] rounded-xl px-3 py-2 text-[10.5px] leading-relaxed shadow-sm whitespace-pre-wrap font-medium ${msg.from === "bot" ? "bg-white text-slate-800 rounded-tl-none" : "bg-[#DCF8C6] text-slate-800 rounded-tr-none"}`, children: [
          msg.from === "employee" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold text-[#075E54] mb-0.5", children: msg.name }),
          msg.text,
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-[9px] text-slate-400 mt-1", children: [
            msg.time,
            " ",
            msg.from === "employee" ? "✓✓" : ""
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 bg-[#F0F0F0] flex gap-2 items-center border-t border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: input, onChange: (e) => setInput(e.target.value), onKeyDown: (e) => e.key === "Enter" && sendMessage(), placeholder: "Type a message...", className: "flex-1 h-9 px-3 rounded-full bg-white border border-border/60 text-xs font-medium outline-none focus:border-[#075E54]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: sendMessage, className: "h-9 w-9 rounded-full bg-[#075E54] hover:bg-[#128C7E] text-white flex items-center justify-center transition-all active:scale-95", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "h-4 w-4" }) })
        ] })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-0 overflow-hidden border border-border bg-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs divide-y divide-border/60", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30 bg-background font-medium text-foreground", children: queryLog.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-secondary/15", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 text-[9.5px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-secondary border border-border px-2 py-0.5 rounded font-mono font-bold text-slate-600", children: q.category }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9.5px] font-extrabold px-2 py-0.5 rounded font-mono border ${q.resolved === "Bot" ? "bg-emerald-50 text-emerald-700 border-emerald-100" : "bg-amber-50 text-amber-700 border-amber-100 animate-pulse"}`, children: q.resolved === "Bot" ? "✅ Bot" : "⏳ HR" }) })
            ] }, i)) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 border border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-3", children: "Policy Knowledge Base" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: [{
            ...
            updated: "Jan 2024"
          }].map((kb, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs font-semibold py-1 border-b border-border/30 last:border-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: kb.doc }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-slate-400 text-[9.5px] shrink-0 ml-3", children: kb.updated })
          ] }, i)) })
        ] })
      ] })
    ] })
