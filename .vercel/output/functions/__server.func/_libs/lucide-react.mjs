...
const MessagesSquare = createLucideIcon("messages-square", __iconNode$s);
const __iconNode$r = [
...
const OctagonAlert = createLucideIcon("octagon-alert", __iconNode$r);
const __iconNode$q = [
  [
    "path",
    {
...
const Smile = createLucideIcon("smile", __iconNode$f);
const __iconNode$e = [
  [
    "path",
    {
