      ...
      actions={
        <>
          <div className="flex rounded-lg border border-border bg-card p-0.5">
            <button className="h-9 w-9 grid place-items-center rounded-md bg-ink text-cream">
              <LayoutGrid className="h-3.5 w-3.5" />
            </button>
            <button className="h-9 w-9 grid place-items-center rounded-md text-muted-foreground">
